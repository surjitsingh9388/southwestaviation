...
return [
     ...
     */
    'Security' => [
        'salt' => env('SECURITY_SALT', 'f5ede0bd1e4f392d7d9c593d00fb2a88fbaf8995e55d4982d77beac1ce65822f'),
    ],
    ...
    'EmailTransport' => [
        'default' => [
            'className' => 'Smtp',
            'host' => 'mail.compavop.com',
            'port' => 587,
            'timeout' => 180,
            'username' => 'ssingh@compavop.com',
            'password' => 'qHrJp{?E+&Mv',
    ...
    'Email' => [
        'default' => [
            'transport' => 'smtp',
            'from' => ['ssingh@compavop.com' => 'Your Name'],
            'emailFormat' => 'html',
        ],
    ],
