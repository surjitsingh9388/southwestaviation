$(document).ready(function() {
    ...
    $(document).on("click", ".saveLaterCls", function(e) {
        ...
        var count = $('form.frmFlightLegs').length; 
        //var promises = [];
        for (let current=1; current<=count; current++) {
        //$('form.frmFlightLegs').each(function() {
            //var form = $(this);
            console.log(current + ' - ' + '#tab'+current+' form.frmFlightLegs');
            var form = $('#tab'+current+' form.frmFlightLegs');
            if(form.valid()) {
    ...
    $(document).on("click", ".deleteLeg", function() {
        var tabnum = $('#tabs li.ui-tabs-active').data('tabnum');
        var flid = $('#tabs li.ui-tabs-active').data('flid');        
