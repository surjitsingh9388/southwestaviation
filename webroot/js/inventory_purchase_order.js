...
$(document).on("keyup change onblur", "form#frmInventoryPOReceive .inventory_item_id, .location_id, .serial_no", function(){
    disableEnableSaveInvPORecBtn();
});
...
function calculatePOTotalAmount(){
    ...
    var totalpoamount = parseFloat(totalamount)+parseFloat(taxcalval);
