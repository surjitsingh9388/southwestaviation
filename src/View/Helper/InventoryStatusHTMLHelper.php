...
class InventoryStatusHTMLHelper extends Helper
{
    ...
    public function getInventoryRequestStatusHTML($status, $request_status){
        if($request_status == '1'){
            ...
            $statushtml = '<span data-html="true" placement="left" class="inventory_request_status inventory-requests-approved">Ordered</span>';
        }else if($request_status == '7'){
            $statushtml = '<span data-html="true" placement="left" class="inventory_request_status inventory-requests-approved">Received</span>';
        }else if($request_status == '8'){
            $statushtml = '<span data-html="true" placement="left" class="inventory_request_status inventory-requests-approved">On Hold</span>';
        }
