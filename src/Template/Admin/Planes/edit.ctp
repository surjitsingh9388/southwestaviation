...
<div class="content sliding">
    <div class="outerWrapper">
        <div class="btnWrapper">
            <h2 class="heading">Update Aircraft</h2>
            <?php
                        ...
                        <div class="form-group"> 
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="input-group date datePicker">
                                    <?php echo $this->Form->Text('airworthiness_date', array('class' => 'form-control col-md-7 col-xs-12 datePicker', 'placeholder' => 'Airworthiness Date', 'label' => false, 'value' => !empty($plane->airworthiness_date) ? date('m-d-Y', strtotime($plane->airworthiness_date)) : '')); ?>
