        ...
        <div class="page-content mt-35">
            <div class="action-bar dflex">
                ...
                <div class="split-btn pull-right actionMenu sortWrap" style="width:auto;">
                    ...
                    <div class="dropdown-content dropdown-menu actionLinks">
                        <a href="javascript:void(0);" class="actionOnSelected printLocBarCodes" onclick="$('#printBarcodesModel').modal('show');" style="pointer-events: none">Print Barcodes</a>
                    </div>
                </div>
                <?php } ?>
            </div>
            ...
            <div class="tableScroll">
                <table id="datatableListingPage" class="table dataTable table2excel <?php if((!empty($actionItems) && $actionItems['action']['action_view']==1) || $sessionUser['id'] == 1) { ?>invlocationtable <?php } ?>" width="100%">
                    <thead>
                        <tr>
                            <th style="vertical-align: top;" class="check noExl"><input type="checkbox" name="air_check" id="ckbCheckAll"></th>
                            ...
                            <th style="vertical-align: top;" scope="col"><?php echo __('Active'); ?></th>
                        </tr>
                    </thead>
                </table>
            </div>
