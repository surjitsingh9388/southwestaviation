                ...
                <table id="datatableListingPage" class="table dataTable table2excel invtransactionreporttable" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th style="vertical-align: top;" scope="col"><?php echo __('From Description'); ?></th>
                            <th style="vertical-align: top;" scope="col"><?php echo __('To Description'); ?></th>
                            <th style="vertical-align: top;" scope="col"><?php echo __('Part Name'); ?></th>
