...
<script type="text/javascript">
    var ajaxListPageSearchURL = "<?php echo $this->Url->build(['controller'=>'InventoryRepairOrders', 'action'=>'ajaxInventoryRepairOrdersearch']); ?>";
    var pagelimit = <?php echo PAGINATION_LIMIT;?>;
    var inventoryPurchaseOrderDetailsURL = "<?php echo $this->Url->build(['controller'=>'InventoryRepairOrders', 'action'=>'detail',]); ?>";
    var exportLineItemsExcelURL = "<?php echo $this->Url->build(['controller'=>'InventoryRepairOrders', 'action'=>'exportRepairLineItems']); ?>";
    var exportListingDataExcelURL = "<?php echo $this->Url->build(['controller'=>'InventoryRepairOrders', 'action'=>'exportRepairOrderListToExcel']); ?>";
...
<div class="content sliding">
    <div class="outerWrapper">
        <div class="btnWrapper">
            <h2 class="heading">Repair Orders</h2>
        ...
        <div class="page-content mt-35">
            <div class="action-bar dflex">
                <div class="input-group search-control mb-0">
                    <input id="searchItem" name="searchItem" type="text" class="form-control" placeholder="Search Repair Orders">
                ...
                <div class="inputWrap btn-group sortWrap" style="margin-left:10px;">
                    ...
                    <select class="selectpicker" id="FilterBy" name="sortBy">
                        ...
                        <option value="6" selected>Submitted Date</option>
                    </select>
                ...
                <table id="datatableListingPage" class="table display dataTable table2excel <?php if((!empty($actionItems) && $actionItems['action']['action_view']==1) || $sessionUser['id'] == 1) { ?>invpotable<?php } ?>" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th style="vertical-align: top;" scope="col"><?php echo __('Order'); ?></th>
                            ...
                            <th style="vertical-align: top;" scope="col"><?php echo __('RO Status'); ?></th>
                        </tr>
                    </thead>
                </table>
            </div>
...
<div id="popupFilterModel" class="modal fade page-content" role="dialog" style="background: transparent;">
    <?php echo $this->element('InventoryFilter/inventory_repair_order_filter'); ?>
</div>
