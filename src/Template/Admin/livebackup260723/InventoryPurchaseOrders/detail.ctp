        ...
        <div class="btnWrapper">
            <h2 class="heading">
                ...
                if($inventorypurchaseorders->po_status == '1'){
                    ...
                    $statushtml = '<span data-html="true" placement="left" class="inventory_request_status inventory-requests-sent">Sent</span>';
                ...
                if($inventorypurchaseorders->po_type == '2'){
                    if($inventorypurchaseorders->exchange_status == '1'){
                        $statushtml .= '<span class="exchange-status-indicator">
                                                <span title="Core exchange status" class="badge badge-dark exchange-status-badge">
                                                <i class="fa fa-exchange"></i>
                                                <span>&nbsp;None</span>
                                            </span>
                                        </span>';
                    }else if($inventorypurchaseorders->exchange_status == '2'){
                        $statushtml .= '<span class="exchange-status-indicator">
                    ...
                    }else if($inventorypurchaseorders->exchange_status == '3'){
                        $statushtml .= '<span class="exchange-status-indicator">
                ...
                if($inventorypurchaseorders->status == '0'){
                    $statushtml .= '&nbsp;<span data-html="true" placement="left" class="inventory_request_status po-inactive">Inactive</span>'; 
                }
                echo $statushtml;
                ?>
                    ...
                    <div class="">
                        <div class="col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <p style="white-space: pre-wrap;" class="form-control-static"><? echo $inventorypurchaseorders->reference; ?></p>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 vendor-address-box">
                            ...
                            <div class="addressdispblock" style="display:none;">
                                        ...
                                        <tbody id="invrequeststbl">
                                            ...
                                            <tr>
                                                <td class="collapse-tr">
                                                    ...
                                                    <i id="po-detail-line-item-0-expansion-arrow" class="fa fa-caret-right invpoitemrec" style="width:10px; cursor:pointer;"></i>
                                                    </div>
                                                ...
                                                <td>
                                                    <?php echo !empty($val['noninventory_item']) ? '' : $this->Form->Text('tracking_number[]', array('class' => 'form-control col-md-3 col-xs-12 etaDatepicker', 'id' => 'tracking_number', 'placeholder' => '', 'label' => false, 'value'=>$val['tracking_number'], 'style'=>'width: 83%;display: inline-block;')).'<div style="display: inline-block;padding-left: 5px;cursor: pointer;padding-top: 7px;"><a target="_new"> <i class="fa fa-truck fa-flip-horizontal"></i></a></div>'; ?>
                                                ...
                                                <td class="collapse-tr">
                                                    ...
                                                    ?>
                                                    <span class="receivedinput" style="display:none;">
                                                ...
                                                <td>
                                                    ...
                                                    <div class="btn-group btn-group-sm">
                                                        ...
                                                        <ul role="menu" class="dropdown-menu action-dropdown-menu">
                                                            ...
                                                            ?>
                                                                <li><a class="dropdown-item" style="color: #333 !important;" href="<?php echo $this->Url->build(['controller'=>'InventoryPurchaseOrders', 'action'=>'receive', $val['inventory_po_id'], $val['id']]); ?>">Receive</a></li>
                                                            <?php }else{ ?>
                                                                <li class="disabled"><a class="dropdown-item" href="javascript:void(0);" style="color: #333 !important;">Receive</a></li>
                                                            <?php } ?>
                                                            <?php
                                                            if($statusmsg == 'Received'){       
                                                            ?>
                                                            <li>
                                                                <a id="po-detail-line-item-adjust-cost-button-0 " class="adjustInvCost" style="cursor: pointer; color: #333 !important;" data-val="<?php echo $val['id']?>">
                                                                    Adjust Inventory Cost
                                                                </a>
                                                            </li>
                                                            <?php }else{ ?>
                                                            <li class="disabled">
                                                                <a id="po-detail-line-item-adjust-cost-button-0" style="cursor: pointer;color: #333 !important;">
                                                                    Adjust Inventory Cost
                                                                </a>
                                                            </li>
                                                            <?php } ?>
