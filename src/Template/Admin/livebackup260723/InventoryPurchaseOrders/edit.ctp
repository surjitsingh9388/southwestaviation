...
<div class="content sliding">
    <div class="outerWrapper">
        ...
        <div class="btnWrapper">
            <h2 class="heading"><?php echo $this->Html->link('Purchase Orders', ['action' => 'index']).' / '.$this->Html->link($inventorypurchaseorders->po_number, ['action' => 'detail', $inventorypurchaseorders->id]).' / Edit'; ?></h2>
            <div class="btnWrap">
             <?php
        ...
        <div class="page-content mt-35">
            <div class="formBGCls">
                <?php echo $this->element('Inventory/edit_purchase_order'); ?>
            </div>
        </div>
...
var deleteInventoriesAttURL = "<?php echo $this->Url->build(['controller'=>'InventoryPurchaseOrders', 'action'=>'deleteInvPOAttachment']); ?>";
