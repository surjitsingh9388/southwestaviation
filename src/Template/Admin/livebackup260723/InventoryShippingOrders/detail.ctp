        ...
        <div class="btnWrapper">
            <h2 class="heading">
                ...
                if($InventoryShippingOrders->shipping_order_status == '1'){
                    $statushtml = '<span data-html="true" placement="left" class="inventory_request_status so-partial">Partial Received</span>';
                    ...
                    $statushtml = '<span data-html="true" placement="left" class="inventory_request_status so-cancelled">Canceled</span>';
                }else if($InventoryShippingOrders->shipping_order_status == '2'){
                    $statushtml = '<span data-html="true" placement="left" class="inventory_request_status so-shipped">Shipped</span>';
                }else if($InventoryShippingOrders->shipping_order_status == '4'){
                    $statushtml = '<span data-html="true" placement="left" class="inventory_request_status so-received">Received</span>';
                }
                
                if($InventoryShippingOrders->status == '2'){
                    ...
                    <div class="">
                        <div class="col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <p style="white-space: pre-wrap;" class="form-control-static"><? echo $InventoryShippingOrders->reference; ?></p>
                                </div>
                            </div>
                                    ...
                                    <table class="table upload-area" id="uploadfile">
                                        <thead class="thead-dark">
                                            <tr class="tblinvpo">
                                                ...
                                                <th class="col-sm-2" style="width:8%;">Quantity</th>
                                                <th class="col-sm-2" style="width:7%;">Received</th>
                                                <th class="col-sm-2" style="width:12%;">Cost/Unit (USD)</th>
                                        ...
                                        <tbody id="invrequeststbl">
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo $this->Form->Text('tracking_number[]', array('class' => 'form-control col-md-3 col-xs-12 etaDatepicker', 'id' => 'tracking_number', 'placeholder' => '', 'label' => false, 'value'=>$val['tracking_number'], 'style'=>'width: 83%;display: inline-block;')); ?>
