                                ...
                                <div class="g-0 bg-light position-relative">
                                    ...
                                    <table class="table upload-area" id="uploadfile">
                                        ...
                                        <tbody id="invrequeststbl">
                                            ...
                                            <tr>
                                                <td>
                                                    <?php echo isset($val['invitms']['name']) ? '<a href="'.$this->Url->build(['controller'=>'InventoryItems', 'action'=>'detail', $val['inventory_item_id']]).'" class="inventory-select-item">'.$val['invitms']['name'].' ('.$val['invitms']['part_number'].')'.'</a>' : $val['noninventory_item']; ?></td>
