 ...
 * @var \Cake\Datasource\EntityInterface $AircraftCategory
 */
...
<div class="content sliding">
    <div class="outerWrapper">
        <div class="btnWrapper">
            <h2 class="heading">Add Aircraft Category</h2>
            <?php
...
$(document).ready(function() {
    ...
    $('#planeName').on('change', function() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo Router::url(['controller'=>'AircraftComponents', 'action'=>'getComponents']); ?>",
