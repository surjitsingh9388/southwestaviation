                        ...
                        <ul id="tabUI">
                            ...
                            if(!empty($fls)) {
                                ...
                                foreach ($fls as $key => $value) {
                                    echo '<li class="tab'.$i.'" data-tabnum="'.$i.'"><a href="#tab'.$i.'"><span class="displayFlyFrom">'. strtoupper($value['flight_from']).'</span>-<span class="displayFlyTo">'.strtoupper($value['flight_to']).'</span></a></li>';
                            
                                    $i++;
                                }
                            } else {
                                echo '<li class="tab1" data-tabnum="1"><a href="#tab1"><span class="displayFlyFrom">?</span>-<span class="displayFlyTo">?</span></a></li>';
                            }                   
                            ?>
                        </ul>
                        <?php 
                                                    ...
                                                    <tbody class="crewMemberList">
                                                        ...
                                                        if(!empty($value['crews'])) {
                                                            foreach ($value['crews'] as $key2 => $value2) {
                                                                $pilotFlying = !empty($value2['pilot_flying']) ? $value2['pilot_flying'] : '--';
                                                                ...
                                                                echo '<tr><input type="hidden" name="crew_id[]" value="'.$value2['id'].'"></tr>
                                                                    ...
                                                                    <td><input type="hidden" name="duty_start_date[]" value="'.$value2['duty_start_date'].'">'.$value2['duty_start_date'].'</td>
                                            ...
                                            <div class="flightInfoCls">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <?php echo $this->Form->Text('ending_fuel', array('class'=>'form-control endFId', 'placeholder'=>'0', 'label'=>false, 'value'=>$value['flightlog_detail']['ending_fuel'])); ?>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        echo $this->Form->control('fuel_type', array('options'=>$legType, 'class'=>'form-control col-md-6 col-xs-12', 'label'=>false, 'value'=>$value['flightlog_detail']['fuel_type']));
                                                        ?>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="flightFields">
                                        ...
                                        <div class="flightInfoCls">
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <label>Starting Fuel</label>
                                                    <input type="text" name="fuel_total" class="form-control startFuelId" placeholder="0" disabled>
                                                </div>
        ...
        if (confirm('Save and close this leg?')) {
            if(that.valid()) {
                if(crewCls == false || (crewMember == '' || typeof crewMember === 'undefined')) {
                    ...
                    //Check manifest
                    if(($('#tab'+tabnum+' .mfMaxWeight').val() == '' || typeof $('#tab'+tabnum+' .mfMaxWeight').val() === 'undefined') || ($('#tab'+tabnum+' .mfActualWeight').val() == '' || typeof $('#tab'+tabnum+' .mfActualWeight').val() === 'undefined') || ($('#tab'+tabnum+' .mfForwardCg').val() == '' || typeof $('#tab'+tabnum+' .mfForwardCg').val() === 'undefined') || ($('#tab'+tabnum+' .mfActualCg').val() == '' || typeof $('#tab'+tabnum+' .mfActualCg').val() === 'undefined') || ($('#tab'+tabnum+' .mfAftCg').val() == '' || typeof $('#tab'+tabnum+' .mfAftCg').val() === 'undefined')) {
                        ...
                        $.ajax({
                            ...
                            data: {tripId:tripId, mfId:mfId},
                            async: true,
                            success: function(response) {
                                var obj = JSON.parse(response);
                                if(obj.status == 'success') {
                                    //Ajax call to save current leg data
                                    var formData = 'trip_id=' + tripId +'&'+ $('#tab'+tabnum+' .frmFlightLegs').serialize();
                ...
                } else if(($('#tab'+tabnum+' .mfMaxWeight').val() == '' || typeof $('#tab'+tabnum+' .mfMaxWeight').val() === 'undefined') || ($('#tab'+tabnum+' .mfActualWeight').val() == '' || typeof $('#tab'+tabnum+' .mfActualWeight').val() === 'undefined') || ($('#tab'+tabnum+' .mfForwardCg').val() == '' || typeof $('#tab'+tabnum+' .mfForwardCg').val() === 'undefined') || ($('#tab'+tabnum+' .mfActualCg').val() == '' || typeof $('#tab'+tabnum+' .mfActualCg').val() === 'undefined') || ($('#tab'+tabnum+' .mfAftCg').val() == '' || typeof $('#tab'+tabnum+' .mfAftCg').val() === 'undefined')) {
                    $('#closeLegModel .modal-body').html('');
                    $('#closeLegModel .modal-body').html('Please complete a manifest for each non Part91 leg of the flight.');
                    $('#closeLegModel').modal('show');
                } else {
    ...
    $(document).on("click", ".closeTripCls", function(e) {
        ...
        if (confirm('Save and close this leg?')) {
            $('form.frmFlightLegs').each(function() {
                //var tabnum = $(this).children('.tabnum').val();
