    ...
    <div class="outerWrapper">
        <div class="btnWrapper flex-column-mob">
            ...
            <div class="btnWrap">
                ...
                <div class="split-btn ml-10" style="margin-bottom: 12px;">
                <?php
                echo $this->Form->control('plane_id', array('options' => $planes, 'empty' => 'Select Aircraft', 'class' => 'btn selectpicker', 'data-show-subtext' => true, 'data-live-search' => true, 'required' => 'required', 'label' => false, 'div'=>false, 'id' => 'aircraftId', 'value'=>$planeId));
                ?>
                </div>
                <?php
                if((!empty($actionItems) && $actionItems['action']['action_add']==1) || $sessionUser['id'] == 1) {
                    echo "<a href='javascript:void(0);' class='btn btn-default' data-plane_id='".$planeId."' id='addDiscrepancy' $style><i class='fa fa-plus'></i> Create Discrepancy</a>";
                }
                ?>
            </div>
        </div>
