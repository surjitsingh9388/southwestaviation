...
<div class="content sliding">
    <div class="outerWrapper">
        ...
        <div class="page-content mt-35">
            <?php echo $this->Form->create($userMenuItems, array('class' => 'form-horizontal form-label-left', 'id' => 'frmAssignMenu', 'role' => 'form', 'data-toggle' => 'validator')); ?>
                    ...
                    <div class="form-group" id="menuItemTable">
                        <table width="100%" class="Panel" border="1">
                            ...
                            <tr style="background-color: #f0f0f0;">
                                ...
                                <th class="text-alignment">Add</th>
                            ...
                            foreach ($menuItems as $key => $menuItem) {
                                if(is_array($menuItem)) {
                                    foreach ($menuItem as $key1 => $subItems) {
                                        ...
                                        if($key1 == 'Inventory'){
                                            echo '<tr style="background-color: #f0f0f0;">
                                                <th style="vertical-align: top; text-align: center;">'.$this->Form->input('menu_item_id.'.$key.'.menu_item_id', ['type' => 'checkbox', 'class' => 'selectAll-Chield checkBoxClass parent-term parent_'.$key, 'label' => false, 'value' => $key, 'id' => $key]).'</th>
                                        ...
                                        foreach ($subItems as $key2 => $value) {
                                            if(!is_array($value)) {
                                                if(!empty($value) && $value == 'Generate Report') {
                                                    echo '<tr>
                                                            <td></td>
                                                            <td style="vertical-align: top; text-align: center">'.$this->Form->input('menu_item_id.'.$key2.'.menu_item_id', ['type' => 'checkbox', 'div'=>false, 'class' => 'checkBoxClass child-term action_parent_'.$key. ' chield_'.$key, 'label' => false, 'value' => $key2, 'id' => 'chield_'.$key]).'</td>
                                                            <td style="" colspan="2"><span style="margin-left:5px;">'.$value.'</span></td>
                                                            <td class="text-alignment">'.$this->Form->input('menu_item_id.'.$key2.'.action_add', ['type' => 'checkbox', 'div'=>false, 'label' => false, 'id' => 'chield_'.$key.'_add_'.$key2, 'class' => 'chield_'.$key. ' action_add_'.$key. ' action check_add add']).'</td>
                                                            <td colspan="3"></td>
                                                        </tr>';
                                                    ...
                                                    echo '<tr>
                                                            ...
                                                            <td style="" colspan="2"><span style="margin-left:5px;">'.$value.'</span></td>
                                                            <td class="text-alignment">'.$this->Form->input('menu_item_id.'.$key2.'.action_add', ['type' => 'checkbox', 'div'=>false, 'label' => false, 'id' => 'chield_'.$key.'_add_'.$key2, 'class' => 'chield_'.$key. ' action_add_'.$key. ' action check_add add']).'</td>
                                                            <td class="text-alignment">'.$this->Form->input('menu_item_id.'.$key2.'.action_edit', ['type' => 'checkbox', 'div'=>false, 'label' => false, 'id' => 'chield_'.$key.'_edit_'.$key2, 'class' => 'chield_'.$key. ' action_edit_'.$key. ' action check_edit edit']).'</td>
                                                            <td class="text-alignment">'.$this->Form->input('menu_item_id.'.$key2.'.action_view', ['type' => 'checkbox', 'div'=>false, 'label' => false, 'id' => 'chield_'.$key.'_view_'.$key2, 'class' => 'chield_'.$key. ' action_view_'.$key. ' action check_view view']).'</td>
                                                            <td class="text-alignment">'.$this->Form->input('menu_item_id.'.$key2.'.action_delete', ['type' => 'checkbox', 'div'=>false, 'label' => false, 'id' => 'chield_'.$key.'_delete_'.$key2, 'class' => 'chield_'.$key. ' action_delete_'.$key. ' action check_delete delete']).'</td>
                                                            <td class="text-alignment">'.$this->Form->input('menu_item_id.'.$key2.'.action_approve_deny', ['type' => 'checkbox', 'div'=>false, 'label' => false, 'id' => 'chield_'.$key.'_approve_deny_'.$key2, 'class' => 'chield_'.$key. ' action_approve_deny_'.$key. ' action check_approve_deny approve_deny']).'</td>
                                                            <td class="text-alignment">&nbsp;</td>
                                                            <td class="text-alignment">&nbsp;</td>
                                                        </tr>';
                                                    ...
                                                    echo '<tr>
                                                            ...
                                                            <td class="text-alignment">'.$this->Form->input('menu_item_id.'.$key2.'.action_delete', ['type' => 'checkbox', 'div'=>false, 'label' => false, 'id' => 'chield_'.$key.'_delete_'.$key2, 'class' => 'chield_'.$key. ' action_delete_'.$key. ' action check_delete delete']).'</td>
                                                            <td class="text-alignment">&nbsp;</td>
                                                            <td class="text-alignment">'.$this->Form->input('menu_item_id.'.$key2.'.action_reopen_work_order', ['type' => 'checkbox', 'div'=>false, 'label' => false, 'id' => 'chield_'.$key.'_reopen_work_order_'.$key2, 'class' => 'chield_'.$key. ' action_reopen_work_order_'.$key. ' action check_reopen_work_order reopen_work_order']).'</td>
                                                            <td class="text-alignment">'.$this->Form->input('menu_item_id.'.$key2.'.action_final_inspections', ['type' => 'checkbox', 'div'=>false, 'label' => false, 'id' => 'chield_'.$key.'_final_inspections_'.$key2, 'class' => 'chield_'.$key. ' action_final_inspections_'.$key. ' action check_final_inspections final_inspections']).'</td>
                                                        </tr>';
                                                } else {
                                                    echo '<tr>
                                                            <td></td>
                                                ...
                                                foreach ($value as $key3 => $valueLast) {
                                                    echo '<tr>
                                                            <td></td>
                                                            <td style="vertical-align: top; text-align: center">'.$this->Form->input('menu_item_id.'.$key2.'.menu_item_id', ['type' => 'checkbox', 'div'=>false, 'class' => 'checkBoxClass child-term action_parent_'.$key. ' chield_'.$key.' lastChield_parent_'.$key2, 'label' => false, 'value' => $key2, 'id' => 'chield_'.$key]).'</td>
                                                            <td style="" colspan="2"><span style="margin-left:5px;">'.$key3.'</span></td><td class="text-alignment">'.$this->Form->input('menu_item_id.'.$key2.'.action_add', ['type' => 'checkbox', 'div'=>false, 'label' => false, 'id' => 'chield_'.$key.'_add_'.$key2, 'class' => 'chield_'.$key. ' action_add_'.$key. ' action check_add add']).'</td>
                                                            <td class="text-alignment">'.$this->Form->input('menu_item_id.'.$key2.'.action_edit', ['type' => 'checkbox', 'div'=>false, 'label' => false, 'id' => 'chield_'.$key.'_edit_'.$key2, 'class' => 'chield_'.$key. ' action_edit_'.$key. ' action check_edit edit']).'</td>
                                                            <td class="text-alignment">'.$this->Form->input('menu_item_id.'.$key2.'.action_view', ['type' => 'checkbox', 'div'=>false, 'label' => false, 'id' => 'chield_'.$key.'_view_'.$key2, 'class' => 'chield_'.$key. ' action_view_'.$key. ' action check_view view']).'</td>
                                                            <td class="text-alignment">'.$this->Form->input('menu_item_id.'.$key2.'.action_delete', ['type' => 'checkbox', 'div'=>false, 'label' => false, 'id' => 'chield_'.$key.'_delete_'.$key2, 'class' => 'chield_'.$key. ' action_delete_'.$key. ' action check_delete delete']).'</td>
                                                            <td class="text-alignment">&nbsp;</td>
                                                    ...
                                                    foreach ($valueLast as $key4 => $value4) {
                                                        ...
                                                        echo '<tr>
                                                                <td></td>
                                                                <td></td>
                                                                <td style="vertical-align: top; text-align: center">'.$this->Form->input('menu_item_id.'.$key5.'.menu_item_id', ['type' => 'checkbox', 'div'=>false, 'class' => 'checkBoxClass child-term action_parent_'.$key. ' chield_'.$key, 'label' => false, 'value' => $key5, 'id' => 'chield_'.$key.'_'.$key2]).'</td>
                                                                <td style=""><span style="margin-left:5px;">'.$value5.'</span></td>
                                                                <td class="text-alignment">'.$this->Form->input('menu_item_id.'.$key5.'.action_add', ['type' => 'checkbox', 'div'=>false, 'label' => false, 'id' => 'chield_'.$key.'_add_'.$key2, 'class' => 'chield_'.$key. ' action_add_'.$key. ' action check_add add']).'</td>
                                                                <td class="text-alignment">'.$this->Form->input('menu_item_id.'.$key5.'.action_edit', ['type' => 'checkbox', 'div'=>false, 'label' => false, 'id' => 'chield_'.$key.'_edit_'.$key2, 'class' => 'chield_'.$key. ' action_edit_'.$key. ' action check_edit edit']).'</td>
                                                                <td class="text-alignment">'.$this->Form->input('menu_item_id.'.$key5.'.action_view', ['type' => 'checkbox', 'div'=>false, 'label' => false, 'id' => 'chield_'.$key.'_view_'.$key2, 'class' => 'chield_'.$key. ' action_view_'.$key. ' action check_view view']).'</td>
                                                                <td class="text-alignment">'.$this->Form->input('menu_item_id.'.$key5.'.action_delete', ['type' => 'checkbox', 'div'=>false, 'label' => false, 'id' => 'chield_'.$key.'_delete_'.$key2, 'class' => 'chield_'.$key. ' action_delete_'.$key. ' action check_delete delete']).'</td>
                                                                <td class="text-alignment">&nbsp;</td>
                                                                <td class="text-alignment">&nbsp;</td>
                                                                <td class="text-alignment">&nbsp;</td>
                                                            </tr>';
                                    ...
                                    echo '<tr>
                                            ...
                                            <td class="text-alignment">'.$this->Form->input('menu_item_id.'.$key.'.action_add', ['type' => 'checkbox', 'label' => false, 'id' => $key, 'class' => 'singleRow chield_'.$key.' check_add']).' </td>
                                            <td class="text-alignment">'.$this->Form->input('menu_item_id.'.$key.'.action_edit', ['type' => 'checkbox', 'label' => false, 'id' => $key, 'class' => 'singleRow chield_'.$key.' check_edit']).'</td>
                                            <td class="text-alignment">'.$this->Form->input('menu_item_id.'.$key.'.action_view', ['type' => 'checkbox', 'label' => false, 'id' => $key, 'class' => 'singleRow chield_'.$key.' check_view']).'</td>
                                            <td class="text-alignment">'.$this->Form->input('menu_item_id.'.$key.'.action_delete', ['type' => 'checkbox', 'label' => false, 'id' => $key, 'class' => 'singleRow chield_'.$key.' check_delete']).'</td>
                                            <td class="text-alignment">'.$this->Form->input('menu_item_id.'.$key.'.action_approve_deny', ['type' => 'checkbox', 'label' => false, 'id' => $key, 'class' => 'singleRow chield_'.$key.' check_approve_deny']).'</td>
                                            <td class="text-alignment">&nbsp;</td>
                                            <td class="text-alignment">&nbsp;</td>
                                        </tr>';
                                }  
