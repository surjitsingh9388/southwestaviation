...
<div class="content sliding">
    <div class="outerWrapper">
        ...
        <div class="page-content mt-35">
            <?php echo $this->Form->create('', array('class' => 'form-horizontal form-label-left', 'id' => 'frmCloneRecords')); ?>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4 col-xs-12" for="plane_id">Select Aircraft <span class="required">*</span></label>
                        ...
                        <div class="col-md-1" style="text-align: center;"><span style="border: 1px solid #c0c0c0; min-height: 500px; width: 1px;"></span></div>
                        
                        <div class="col-md-6">
                            <div><h4><u>Clone To</u></h4></div>

                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4 col-xs-12" for="plane_code">Registration Code <span class="required">*</span>
                                </label>
                                <div class="col-md-8 col-sm-8 col-xs-12">
