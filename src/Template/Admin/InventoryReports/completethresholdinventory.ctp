...
<script type="text/javascript">
    ...
    var ajaxListPageSearchURL = "<?php echo $this->Url->build(['controller'=>'InventoryReports', 'action'=>'ajaxCompleteThresholdSearch']); ?>";
    var exportLineItemsExcelURL = "<?php echo $this->Url->build(['controller'=>'InventoryReports', 'action'=>'exportCompleteThresholdInventory']); ?>";
    if(hashes != ''){
    ...
    var pdfPagTitle = 'INVENTORY THRESHOLD REPORT';
</script>
...
<div class="content sliding">
    <div class="outerWrapper">
        <div class="btnWrapper">
            <h2 class="heading"><?php echo $this->Html->link('Inventory Reports', ['action' => 'index']).' / Inventory Complete Threshold Report'; ?></h2>
            ...
            <div class="float-right">
                ...
                <select class="selectpicker" id="reportRedirectUrl">
                    ...
                    <option value="<?php echo $this->Url->build(['controller'=>'InventoryReports', 'action'=>'completethresholdinventory']); ?>" selected>Inventory Complete Threshold</option>
