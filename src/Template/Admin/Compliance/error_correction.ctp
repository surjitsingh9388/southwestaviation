                ...
                ?>
                    <div class="item <?php echo $active; ?>">
                        <div class="btnWrapper">
                            ...
                            Error Correction <?php echo $i." of ".$partCount." - ".$airCompParts['plane']['plane_code']." #".$airCompParts['id'].", ".$airCompParts['ata_code']." ".$airCompParts['mfg_code']; ?>
                            <span class="glyphicon glyphicon-triangle-bottom partSelectorBtn"></span>
                            <?php
                            } else {
                            ?>
                            <h2 class="heading">
                            Work Completed / <?php echo $airCompParts['plane']['plane_code']." #".$airCompParts['id'].", ".$airCompParts['ata_code']." ".$airCompParts['mfg_code']; ?> / Error Correction
                            <?php
                            }
                            ?>
                            </h2>
                                        ...
                                        <div class="tab-content">
                                            <div id="itemInfo<?php echo $i; ?>" class="tab-pane fade in active">
                                                    ...
                                                    <div class="itemInfoCls">
                                                        <div class="itemCls">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                                                    <?php echo $this->Form->control('last_cw_hrs', array('class'=>'form-control col-md-7 col-xs-12 last-cw-hrs keypress', 'label'=>false, 'value'=>!empty($airCompParts['airframe_component_last_cw'][0]['last_cw_hrs'])?$airCompParts['airframe_component_last_cw'][0]['last_cw_hrs']:'', 'autocomplete'=>'off')); ?>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                                                    <?php echo $this->Form->control('last_cw_afl', array('class'=>'form-control col-md-7 col-xs-12 last-cw-afl keypress', 'label'=>false, 'value'=>!empty($airCompParts['airframe_component_last_cw'][0]['last_cw_afl'])?$airCompParts['airframe_component_last_cw'][0]['last_cw_afl']:'', 'autocomplete'=>'off')); ?>
                                                                </div>
                                                            </div>                               
                                                        </div>
                                                ...
                                                <div class="item-info">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                            <?php echo $this->Form->control('work_description', array('class'=>'form-control col-md-7 col-xs-12', 'label'=>false, 'rows'=>3)); ?>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="item-info">
                                                    ...
                                                    <div class="partInfoCls">
                                                        ...
                                                        <?php
                                                            ...
                                                            echo $this->Form->control('installed_status', array('options' => $installStatus, 'empty' => 'Enter status', 'class' => 'form-control col-md-7 col-xs-12 selectpicker', 'data-show-subtext' => true, 'data-live-search' => true, 'label' => false, 'value'=>!empty($airCompParts['installed_status']) ? $airCompParts['installed_status'] : '', 'autocomplete'=>'off'));
                                                        ?>
                                                        </div>
                                                ...
                                                <div class="item-info">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-10 col-sm-10 col-xs-12">
                                                            <?php echo $this->Form->control('notes', array('class' => 'form-control col-md-7 col-xs-12', 'label' => false, 'rows'=>3)); ?>
                                                        </div>
                                                    </div>
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="m-progress">
                    ...
                    <div class="m-progress-complete">2
                    </div>
                </div>
            </div>
...
$(document).ready(function() {
    ...
    //Update next due and remaining due if overdue checked 
