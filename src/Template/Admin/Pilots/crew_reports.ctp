                        ...
                        <div class="panel-heading">
                            <div class="selectWrap">
                                <div class="lft-Wrapper">
                                    <?php 
                                    echo $this->Form->input('pilot_id', array('options'=>$allPilots, 'class'=>'form-control selectpicker selDropDCls', 'div'=>false, 'label' => 'Choose Crew Member', 'value'=>$pilotId));
                                    ?>
                                </div>
                                ...
                                <div style="width: 40%;">
                                    <button id="crewReportBtn" class="btn btn-success" style="float: right;">Print Report</button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row" id="displayHtmlCls">
                                <div>
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-4 col-sm-4 col-xs-12">Pilot Name:</div>
                                            <div class="col-md-8 col-sm-8 col-xs-12" id="pilotNameCls">
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <div class="col-md-4 col-sm-4 col-xs-12">Pilot Certificate Number:</div>
                                            <div class="col-md-8 col-sm-8 col-xs-12" id="pilotCertCls">
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <div class="col-md-4 col-sm-4 col-xs-12">Report Range:</div>
                                            <div class="col-md-8 col-sm-8 col-xs-12" id="reportRangeCls">
                                            </div>
                                        </div>
                                    </div>
...
$(document).ready(function() {
    ...
    function getCrewReports(pilotid, startDate, endDate) {
        $.ajax({
            ...
            data: {pilotid:pilotid, startDate:startDate, endDate:endDate, type:'web'},
            async: true,
            beforeSend: function () {
                $('.loader').show();
            },
    ...
    $('#crewReportBtn').on('click', function(e) {
        ...
        $.ajax({
            ...
            data: {pilotid:pilotid, startDate:startDate, endDate:endDate, type:'pdf'},
            beforeSend: function () {
                $('.loader').show();
            },
            success:function(response) {
