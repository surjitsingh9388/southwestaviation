    ...
    ?>    
        ...
        <div class="page-content mt-35">
            ...
            <div class="formBGCls">
                ...
                <div class="addPartBorder">
                    <div class="addPageHeading">
                        <div class="col-md-4 col-sm-4 col-xs-12">Part Information</div>
                        <div class="col-md-4 col-sm-4 col-xs-12">Times Since (at Installed)</div>
                        <div class="col-md-4 col-sm-4 col-xs-12">Additional Information</div>
                    </div>
