...
<div class="addPartBorder" style="padding-top:10px;">
    <div class="row">
        <div class="col-md-4">
            <div class="form-group"> 
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                    <?php echo $this->Form->control('shipping_order_number', array('class'=>'form-control col-md-2 col-xs-12', 'placeholder' => '', 'label' => false, 'required' => 'required', 'id'=>'shipping_order_number')); ?>
                </div>
            </div>
        ...
        <div class="col-md-4">
            ...
            <div class="form-group toaddressblock" style="display:none;"> 
            ...
            <div class="form-group thirdpartyblock" style="display:none;">
                <div class="row mb-3">
                    <div class="col-md-12">
                        <div class="form-group"> 
            ...
            <div id="itemHistory" class="tab-pane fade"><!--history-tab-section start -->
                <div class="g-0 bg-light position-relative">
                    <table class="table upload-area tblinvpo">
                        ...
                        <tbody>
                            <tr>
                                <td colspan="5">Under Development</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
