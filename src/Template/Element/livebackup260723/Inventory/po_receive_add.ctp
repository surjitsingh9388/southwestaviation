...
?>
<div class="addPartBorder" id="tab-<?php echo $start; ?>" style="display:none;">
    <h2 class="heading" style="color:black; padding-left: 15px;"><?php echo $invitem['invitms']['name'].' (PN: '.$invitem['invitms']['part_number'].')';?></h2>
