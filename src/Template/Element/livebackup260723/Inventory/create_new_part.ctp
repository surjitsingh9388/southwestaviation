<style>
    ...
    #is-this-item-serialized-0, #accept-install-0{
        margin-left:5px;
    }
</style>
    ...
    <div class="row mb-3">
        <div class="col-md-6">
            <div class="form-group"> 
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                <?php echo $this->Form->control('safety_stock_threshold', array('class'=>'form-control col-md-8 col-xs-12', 'placeholder' => '', 'label' => false)); ?>
                </div>
            </div>
        </div>
    ...
    <div class="row mb-3">
        <div class="col-md-6">
            <div class="form-group"> 
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                <?php echo $this->Form->control('unit_cost', array('class'=>'form-control col-md-8 col-xs-12', 'placeholder' => '', 'label' => false)); ?>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12" id="airCompsList">
                    ...
                    echo $this->Form->control('currency', array('options' => $currency, 'class' => 'form-control col-md-8 col-xs-12 selectpicker', 'data-show-subtext' => true, 'data-live-search' => true, 'label' => false, 'id' => 'currency')); 
                    ?>
                </div>
            </div>
        </div>
    ...
    <div class="row mb-3">
        <div class="col-md-6">
            <div class="form-group"> 
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                <?php echo $this->Form->control('exchange_cost', array('class'=>'form-control col-md-8 col-xs-12', 'placeholder' => '', 'label' => false)); ?>
                </div>
            </div>
        </div>
    ...
    <div class="row mb-3">
        <div class="col-md-6">
            <div class="form-group"> 
                ...
                ?>
                <div class="col-md-1 col-sm-1 col-xs-12 plusbtn"><button class="btn btn-primary manufacturerbtn" style="height:34px;" type="button"><i class="fa fa-plus"></i></button></div>
                <?php } ?>
                </div>
            </div>
        </div>
    ...
    <div class="row mb-3">
        <div class="col-md-6">
            <div class="form-group"> 
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                <?php echo $this->Form->control('description', array('class' => 'form-control col-md-8 col-xs-12', 'label'=> false, 'row mb-3s'=>2)); ?>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                <?php echo $this->Form->control('notes', array('class' => 'form-control col-md-8 col-xs-12', 'label'=> false, 'row mb-3s'=>2)); ?>
                </div>
            </div>
        </div>
    </div>
    <div class="row mb-3">
        <div class="col-md-6">
            <div class="form-group"> 
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                <?php echo $this->Form->control('tags', array('class'=>'form-control col-md-8 col-xs-12', 'placeholder' => '', 'label' => false, 'style'=>"width:auto !important")); ?>
