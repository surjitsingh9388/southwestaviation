<div class="modal-dialog" style="width: 40%; height:auto;">
    <div class="modal-content">
        ...
        <div class="modal-body" style="max-height: auto; overflow-y: auto;">
            <?php echo $this->Form->create('', ['url' =>'', 'id' => 'formPurchaseOrderFilter', 'autocomplete'=>'off']); ?>
                        ...
                        <div class="form-group"> 
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <div class="input-group date datePicker">
                                    <?php echo $this->Form->Text('po_date_start', array('class' => 'form-control col-md-4 col-xs-12 datePicker', 'id' => 'po_date_start', 'placeholder' => '', 'label' => false, 'placeholder'=>'e.g. '.date('m-d-Y'))); ?>
                ...
                <div class="row mt5">
                    <div class="col-md-12">
                        <div class="form-group"> 
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <div class="input-group date datePicker">
                                    <?php echo $this->Form->Text('po_date_end', array('class' => 'form-control col-md-4 col-xs-12 datePicker', 'id' => 'po_date_end', 'placeholder' => '', 'label' => false, 'placeholder'=>'e.g. '.date('m-d-Y'))); ?>
                                    <span class="input-group-addon" style="display:none;">
                                        <span class="glyphicon glyphicon-calendar"></span>
                                    </span>
                                </div>
