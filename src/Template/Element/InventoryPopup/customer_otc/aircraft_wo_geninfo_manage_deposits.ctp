                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="form-input-frame">
                                                <?php echo $this->Form->control('amount_to_add', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'')); ?>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="form-input-frame">
                                                ...
                                                echo $this->Form->control('currency', array('options' => $currencyList, 'empty' => 'Select', 'class' => 'form-control selectpicker', 'data-show-subtext' => true, 'data-live-search' => true, 'label' => false, 'id' => 'deposit_currency'));
                                                ?>   
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="form-input-frame">
                                                ...
                                                echo $this->Form->control('payment_method', array('options' => $woPaymentMethod, 'empty' => 'Select', 'class' => 'form-control selectpicker', 'data-show-subtext' => true, 'data-live-search' => true, 'label' => false, 'id' => 'payment_method'));
                                                ?>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-input-frame">
                                                ...
                                                echo $this->Form->control('paid_by', array('options' => $billtocustomer, 'empty' => 'Select', 'class' => 'form-control selectpicker', 'data-show-subtext' => true, 'data-live-search' => true, 'label' => false, 'id' => 'paid_by')); ?>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
