                    ...
                    <div class="col-md-12 wosignoffallitm">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                ?>
                                <tr class="wo-signoff-tr <?php if($woitem['wo_item_status'] == '1') { ?>wosignoff-color-box2 <?php }else if($woitem['wo_item_status'] == '3') { ?> wosignoff-color-box1<?php } ?>" data-val="<?php echo $woitem['id']; ?>">
