                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="form-input-frame">
                                    <?php echo $this->Form->control('labor_cost', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'')); ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="form-input-frame">
                                    <?php echo $this->Form->control('part_cost', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'')); ?>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="form-input-frame">
                                    <?php echo $this->Form->control('labor_charge', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'')); ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="form-input-frame">
                                    <?php echo $this->Form->control('parts_charge', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'')); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="form-input-frame">
                                    <?php echo $this->Form->control('ship_out', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'')); ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="form-input-frame">
                                    <?php echo $this->Form->control('ship_in', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'')); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="form-input-frame">
                                    <?php echo $this->Form->control('owner', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'')); ?>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6"></div>
                    ...
                    <div class="col-md-6">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="form-input-frame">
                                    <?php echo $this->Form->control('mparts_cost', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'', 'disabled'=>$poitemdisable)); ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="form-input-frame">
                                    <?php echo $this->Form->control('mparts_retail', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'', 'disabled'=>$poitemdisable)); ?>
                                </div>
                            </div>
                        </div>
                    </div>
