                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="form-input-frame">
                                <?php
                                echo $this->Form->control('part_number', array('options' => $invpartnumbers, 'empty' => 'Select Part No.', 'class' => 'form-control selectpicker', 'data-show-subtext' => true, 'data-live-search' => true, 'label' => false, 'id' => 'wo_item_part_number'));
                                ?>
                            </div>
                        </div>
                ...
                <div class="row">
                        ...
                        <div class="col-md-12 pd0">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-input-frame">
                                        <?php echo $this->Form->control('qty_stock', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'', 'readonly'=>'readonly', 'id'=>'wo_item_part_qty_stock')); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <div class="form-input-frame">
                                <?php echo $this->Form->control('price_each', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'$0.00', 'id'=>'price_each')); ?>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <div class="form-input-frame">
                                <?php echo $this->Form->control('give_discount_percentage', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'0.00%', 'id'=>'give_discount_percentage')); ?>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <div class="form-input-frame">
                                <?php echo $this->Form->control('part_total_prices', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'$0.00', 'id'=>'part_total_prices', 'readonly'=>'readonly')); ?>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <div class="form-input-frame">
                                <?php echo $this->Form->control('part_ship_in', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'$0.00')); ?>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <div class="form-input-frame">
                                <?php echo $this->Form->control('part_ship_out', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'$0.00')); ?>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="form-input-frame">
                                    <?php echo $this->Form->control('cost_in_mparts', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'$0.00')); ?>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="form-input-frame">
                                    <?php echo $this->Form->control('retail_price_in_mparts', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'')); ?>
                                </div>
                            </div>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <div class="form-input-frame">
                                <?php echo $this->Form->control('dealer_price', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'$0.00')); ?>
                            </div>
                        </div>
