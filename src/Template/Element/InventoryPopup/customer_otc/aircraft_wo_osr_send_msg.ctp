    ...
    <div class="modal-dialog" style="width: 20%;">
        ...
        <div class="modal-content">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="form-input-frame">
                                <?php
                                    echo $this->Form->control('repair_done_by', array('options' => $userlist, 'empty' => '', 'class' => 'form-control selectpicker', 'data-show-subtext' => true, 'data-live-search' => true, 'label' => false, 'id' => 'repair_done_by'));
                                ?>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary sendWOOSRMsg" data-dismiss="modal">Continue</button>
            </div>
        </div>
        <?php 
        //echo $this->Form->end(); 
