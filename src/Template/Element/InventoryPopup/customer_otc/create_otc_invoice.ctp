                ...
                <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-input-frame">
                                        <?php echo $this->Form->control('additional_ship_in_cost', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'0.00')); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-input-frame">
                                <?php echo $this->Form->control('additional_ship_out_cost', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'0.00')); ?>
                            </div>
                        </div>
