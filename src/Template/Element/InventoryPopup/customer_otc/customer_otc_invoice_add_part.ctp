                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <div class="form-input-frame">
                                <?php echo $this->Form->control('price_each', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'$0.00', 'id'=>'otc_invoice_part_price_each')); ?>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <div class="form-input-frame">
                                <?php echo $this->Form->control('give_discount_percentage', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'0.00%', 'id'=>'otc_invoice_give_discount_percentage')); ?>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <div class="form-input-frame">
                                <?php echo $this->Form->control('part_total_prices', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'$0.00', 'id'=>'otc_invoice_part_total_prices', 'readonly'=>'readonly')); ?>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <div class="form-input-frame">
                                <?php echo $this->Form->control('aoc_charge', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'$0.00')); ?>
                            </div>
                        </div>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <div class="form-input-frame">
                                <?php echo $this->Form->control('drop_ship_charges', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'$0.00')); ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-input-frame">
                                <?php echo $this->Form->control('ship_out', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'$0.00', 'id'=>'invoice_ship_out')); ?>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <div class="form-input-frame">
                                <?php echo $this->Form->control('misc_charges', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'$0.00', 'id'=>'invoice_misc_charges')); ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-input-frame">
                                <?php echo $this->Form->control('hazardous_fee', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'$0.00')); ?>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2">
