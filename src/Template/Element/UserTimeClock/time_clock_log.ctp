    ...
    <div class="modal-dialog" style="width: 40%;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo $this->Form->create('', array('class' => 'form-horizontal form-label-left', 'id' => 'frmTimeClockReports')); ?>
                <div  class="row">
                    <div class="col-md-9">
                        <div class="col-md-12">
                    ...
                    <div class="col-md-3">
                        <div class="col-md-12">
                            <button type="button" class="btn btn-default col-md-12 previewTimeClockReports">Preview</button>
                        </div>
                        <div class="col-md-12">
                            <button type="button" class="btn btn-default col-md-12" disabled>Print</button>
                        </div>
                        <div class="col-md-12">
                            <button type="button" class="btn btn-default col-md-12" disabled>Print All</button>
                        </div>
                        <div class="col-md-12">
                            <button type="button" class="btn btn-default col-md-12" disabled>Export</button>
                        </div>
                    </div>
                </div>
