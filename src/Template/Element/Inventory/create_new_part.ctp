    ...
    <div class="row mt5">
        <div class="col-xs-6">
            <div class="form-group"> 
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                    <?php echo $this->Form->control('exchange_price', array('class'=>'form-control col-md-8 col-xs-12', 'placeholder' => '', 'label' => false)); ?>
                </div>
            </div>
        </div>
        ...
        <div class="col-xs-6">
            <div class="form-group">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12" id="airCompsList">
                    <?php echo $this->Form->control('retail_price', array('class'=>'form-control col-md-8 col-xs-12', 'placeholder' => '', 'label' => false)); ?>
                </div>
            </div>
        </div>
    </div>
    <div class="row mt5">
        <div class="col-xs-6">
            <div class="form-group"> 
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                    <?php echo $this->Form->control('company_purchase_price', array('class'=>'form-control col-md-8 col-xs-12', 'placeholder' => '', 'label' => false)); ?>
                </div>
            </div>
        </div>
        ...
        <div class="col-xs-6">
            <div class="form-group">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12" id="airCompsList">
                    <?php echo $this->Form->control('overhauled_cost', array('class'=>'form-control col-md-8 col-xs-12', 'placeholder' => '', 'label' => false)); ?>
                </div>
            </div>
        </div>
    </div>
