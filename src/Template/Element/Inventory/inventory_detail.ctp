    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group"> 
                ...
                <label class="control-label col-md-4 col-sm-2 col-xs-12 label-cost" for="plane_id">UOM:</label>
                ...
                <label class="control-label col-md-4 col-sm-2 col-xs-12 label-width-auto" for="plane_id">Qty :</label>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group"> 
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                    <p class="form-control-static"><?php echo $invenotries['company_purchase_price']; ?></p>
                </div>
            </div>
        </div>
