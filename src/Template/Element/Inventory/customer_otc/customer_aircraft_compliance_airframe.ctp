<section class="top-form-section aricraftcomplairframeblock">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="col-md-12">
                <div class="form-group">  
                    ...
                    <div class="col-md-5">
                        ...
                        echo $this->Form->control('time_at_install', array('class'=>'form-control col-md-5', 'placeholder' => '', 'label' => false, 'id'=>'airframe_time_at_install', 'readonly'=>$aircraftimeatinstallreadonly)); ?>
                    </div>
            ...
            <div class="col-md-12">
                <div class="form-group">  
                    <label class="control-label col-md-4" for="plane_id">AC TT at Install</label>
                    <div class="col-md-5">
                        <?php 
                        ...
                        echo $this->Form->control('ac_tt_at_install', array('type'=>'number', 'class'=>'form-control col-md-5', 'placeholder' => '', 'label' => false, 'id'=>'airframe_ac_tt_at_install', 'readonly'=>$aircrafacttatinstallreadonly)); ?>
                    </div>
                    <div class="col-md-3"></div>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="form-group">  
                    <label class="control-label col-md-4" for="plane_id">AC Tach at Install</label>
                    <div class="col-md-5">
            ...
            <div class="col-md-12">
                <div class="form-group">  
                    <label class="control-label col-md-4" for="plane_id">Current AC TT</label>
                    <div class="col-md-5">
            ...
            <div class="col-md-12">
                <div class="form-group">  
                    <label class="control-label col-md-4" for="plane_id">Due Next - AC TT</label>
                    <div class="col-md-5">
        ...
        <div class="col-md-6">
            ...
            <div class="col-md-12">
                <div class="form-group">  
                    <label class="control-label col-md-4" for="plane_id">Cycle at Installed</label>
                    <div class="col-md-8">
                        <?php 
            ...
            <div class="col-md-12">
                <div class="form-group">  
                    <label class="control-label col-md-4" for="plane_id">Lndgs at Installed</label>
                    <div class="col-md-8">
                        <?php 
            ...
            <div class="col-md-12">
                <div class="form-group">  
                    <label class="control-label col-md-4" for="plane_id">Current AC Lndgs</label>
                    <div class="col-md-8">
            ...
            <div class="col-md-12">
                <div class="form-group">  
                    <label class="control-label col-md-4" for="plane_id">Due (Cycles)</label>
                    <div class="col-md-8">
            ...
            <div class="col-md-12">
                <div class="form-group">  
                    <label class="control-label col-md-4" for="plane_id">Due Next - Lndgs</label>
                    <div class="col-md-8">
            ...
            <div class="col-md-12">
                <div class="form-group">  
                    ...
                    <div class="form-input-frame">
                        <?php echo $this->Form->control('notes', array('type'=>'textarea', 'class' => 'form-control aircraft-notes', 'label'=> false, 'style'=>'width: 394px; height: 172px;', 'id'=>'airframe_notes')); ?>
                    </div>
                </div>
            </div>
