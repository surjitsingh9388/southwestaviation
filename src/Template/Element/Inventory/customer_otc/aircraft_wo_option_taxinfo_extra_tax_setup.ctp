        ...
        <div class="col-md-12">
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <div class="form-input-frame">
                        <?php echo $this->Form->control('tax_percentage', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'0.00%')); ?>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
        ...
        <div class="col-md-12">
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <div class="form-input-frame">
                        <?php echo $this->Form->control('minimum_amount_to_charge', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'0.00%')); ?>
                    </div>
                </div>
            </div>
            <div class="col-md-4">&nbsp;</div>
        ...
        <div class="col-md-12">
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <div class="form-input-frame">
                        <?php echo $this->Form->control('maximum_amount_to_charge', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'0.00%')); ?>
                    </div>
                </div>
            </div>
            <div class="col-md-4">&nbsp;</div>
