    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <div class="form-group">
                ...
                <div class="form-input-frame">
                    <?php echo $this->Form->control('p_tspoh_r', array('type'=>'number', 'class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'')); ?>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="form-input-frame">
                    <?php echo $this->Form->control('p_tt_r', array('type'=>'number', 'class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'')); ?>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="form-input-frame">
                    <?php echo $this->Form->control('p_last_prop_bal_r', array('type'=>'number', 'class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'')); ?>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-2">
            ...
            <div class="form-group">
                ...
                <div class="form-input-frame">
                    <?php echo $this->Form->control('p_tsn_r', array('type'=>'number', 'class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'')); ?>
                </div>
            </div>
        </div>
