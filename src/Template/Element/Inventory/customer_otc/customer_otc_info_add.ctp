<section class="top-form-section">
    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <div class="form-group">
                <div class="form-input-frame">
                    <?php echo $this->Form->control('percentage_off_over_cost_val', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'0.00%')); ?>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="form-input-frame">
                    <?php echo $this->Form->control('max_outstanding_amount', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'$0.00')); ?>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            ...
            <div class="form-group">
                ...
                <div class="form-input-frame">
                    <?php echo $this->Form->control('total_amount_spent', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'$0.00')); ?>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="form-input-frame">
                    <?php echo $this->Form->control('outstanding_amount_due', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'$0.00')); ?>
                </div>
            </div>
        </div>
