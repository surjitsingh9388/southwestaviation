                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="form-input-frame">
                                    <?php echo $this->Form->control('epa_charge_amount', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'')); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="control-label" for="reference">Amount (Single)</label>
                                <div class="form-input-frame">
                                    <?php echo $this->Form->control('oil_analysis_amount', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'')); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <div class="form-input-frame">
                                    <?php echo $this->Form->control('amount_per_tire', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'')); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="form-input-frame">
                                    <?php echo $this->Form->control('mis_charge_amount', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'$0.00')); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="control-label" for="reference">Amount</label>
                                <div class="form-input-frame">
                                    <?php echo $this->Form->control('pilot_services_amount', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'$0.00')); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="control-label" for="reference">Amount</label>
                                <div class="form-input-frame">
                                    <?php echo $this->Form->control('tax_credit_amount', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'$0.00')); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <fieldset class="scheduler-border">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="control-label" for="reference">Amount</label>
                            <div class="form-input-frame">
                                <?php echo $this->Form->control('shop_supplies_amount', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'$0.00')); ?>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                ...
                <fieldset class="scheduler-border">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="form-input-frame">
                                <?php echo $this->Form->control('fuel_price', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'$0.00')); ?>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-1">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="form-input-frame">
                                ...
                                echo $this->Form->control('epa_total_charges', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'$0.00', 'value'=>$total_charges, 'id'=>'epa_total_charges')); ?>
                            </div>
                        </div>
                    </div>
