<section class="top-form-section">
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            ...
            <div class="form-group">
                <label class="control-label" for="reference">APU Make</label>
                <div class="form-input-frame">
                    <?php echo $this->Form->control('apu_make', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'', 'id'=>'maint_apu_make')); ?>
                </div>
            </div>

            <div class="form-group">
                <label class="control-label" for="reference">APU TCSO</label>
                <div class="form-input-frame">
                    <?php echo $this->Form->control('apu_tcso', array('type'=>'number', 'class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'', 'id'=>'maint_apu_tcso')); ?>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-2">
            ...
            <div class="form-group">
                <label class="control-label" for="reference">APU Model</label>
                <div class="form-input-frame">
                    <?php echo $this->Form->control('apu_model', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'', 'id'=>'maint_apu_model')); ?>
                </div>
            </div>

            <div class="form-group">
                <label class="control-label" for="reference">APU TSN</label>
                <div class="form-input-frame">
                    <?php echo $this->Form->control('apu_tsn', array('type'=>'number', 'class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'', 'id'=>'maint_apu_tsn')); ?>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-2">
            ...
            <div class="form-group">
                <label class="control-label" for="reference">APU Serial</label>
                <div class="form-input-frame">
                    <?php echo $this->Form->control('apu_serial', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'', 'maint_apu_serial')); ?>
                </div>
            </div>

            <div class="form-group">
                <label class="control-label" for="reference">Airframe TT</label>
                <div class="form-input-frame">
                    <?php echo $this->Form->control('airframe_tt', array('type'=>'number', 'class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'', 'maint_airframe_tt')); ?>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-2">
            ...
            <div class="form-group">
                <label class="control-label" for="reference">APU TSO</label>
                <div class="form-input-frame">
                    <?php echo $this->Form->control('apu_tso', array('type'=>'number', 'class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'', 'id'=>'maint_apu_tso')); ?>
                </div>
            </div>
        ...
        <div class="col-md-2">
            ...
            <div class="form-group">
                <label class="control-label" for="reference">APU TC</label>
                <div class="form-input-frame">
                    <?php echo $this->Form->control('apu_tc', array('type'=>'number', 'class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'', 'id'=>'maint_apu_tc')); ?>
                </div>
            </div>
