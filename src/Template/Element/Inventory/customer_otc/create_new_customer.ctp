<section class="top-form-section">
    <?php
    echo $this->Form->create($inventorycustomers, array('action'=>'saveCustomerInfo', 'class' => 'form-horizontal form-label-left', 'id' => 'frmInventoryCustomerInfo', 'autocomplete' => 'off'));
    ?>
        ...
        <div class="col-md-3">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="form-input-frame">
                        <?php echo $this->Form->control('ship_to_country', array('options' => $countries, 'empty' => 'Select a ship to country...', 'class' => 'form-control col-md-8 col-xs-12 selectpicker', 'data-show-subtext' => true, 'data-live-search' => true, 'label' => false, 'id' => 'customer_ship_to_country', 'disabled'=>'disabled'));  ?>
                    </div>
                </div>
            </div>
        </div>
