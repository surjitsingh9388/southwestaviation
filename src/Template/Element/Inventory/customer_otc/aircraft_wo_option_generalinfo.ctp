    ...
    <div class="row">
                ...
                <fieldset class="scheduler-border">
                    ...
                    <div class="col-md-6">
                        <div class="form-group d-flex">
                            ...
                            <div class="form-input-frame">
                                <?php 
                                echo $this->Form->Text('shelf_life', array('class' => 'form-control', 'id' => 'po_item_shelf_life', 'placeholder' => '', 'label' => false, 'readonly'=>'readonly')); ?>
                            </div>
                        </div>
                    </div>
                </fieldset>
        ...
        <div class="col-md-12">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <div class="form-input-frame">
                        <?php echo $this->Form->control('min_hour_worked_per_item', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'')); ?>
                    </div>
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <div class="form-input-frame">
                        <?php echo $this->Form->control('overtime_hrs', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'')); ?>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <div class="form-input-frame">
                        <?php echo $this->Form->control('add_hrs_inspection', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'')); ?>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group d-flex">
                    ...
                    <div class="input-group date datePicker">
                        <?php 
                        echo $this->Form->Text('date_due', array('class' => 'form-control', 'id' => 'po_item_shelf_life', 'placeholder' => '', 'label' => false)); ?>
            ...
            <fieldset class="scheduler-border">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div class="form-input-frame">
                            <?php echo $this->Form->control('total_deposit_amount', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'$0.00')); ?>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <div class="form-input-frame">
                        <?php echo $this->Form->control('accounting_invoice', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'$0.00')); ?>
                    </div>
                </div>
            </div>
        </div>
