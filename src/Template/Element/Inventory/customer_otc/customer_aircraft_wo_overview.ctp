                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <div class="form-input-frame">
                                    <?php echo $this->Form->control('shipping_in', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'$0.00', 'disabled'=>$isdisabled)); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="form-input-frame">
                                    <?php echo $this->Form->control('special_rate_hr', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'$0.00', 'disabled'=>$isdisabled)); ?>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="form-input-frame">
                                    <?php echo $this->Form->control('estimated_hour', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'0', 'disabled'=>$isdisabled)); ?>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <div class="form-input-frame">
                                    <?php 
                                    $estimated_rate = !empty(@$aircraftwoitemoverviews->estimated_rate) ? @$aircraftwoitemoverviews->estimated_rate : ESTIMATEDRATE;
                                    echo $this->Form->control('estimated_rate', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'$0.00', 'value'=>$estimated_rate, 'disabled'=>$isdisabled)); ?>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <div class="form-input-frame">
                                    <?php echo $this->Form->control('flat_rate', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'$0.00', 'disabled'=>$isdisabled)); ?>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-2">
