    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group"> 
                ...
                <?php 
                echo $this->Form->control('name', array('class'=>'form-control col-md-8 col-xs-12 mf_name', 'placeholder' => '', 'label' => false, 'required' => 'required', 'id'=>'addressname'));
                ?>
                </div>
            </div>
        </div>
    ...
    <div class="row mt10">
        <div class="col-md-12">
            <div class="form-group"> 
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                <?php 
                echo $this->Form->control('street1', array('class'=>'form-control col-md-8 col-xs-12 mf_name', 'placeholder' => '', 'label' => false, 'required' => 'required', 'id'=>'addressstreet1'));
                ?>
                </div>
            </div>
        </div>
    ...
    <div class="row mt10">
        <div class="col-md-12">
            <div class="form-group"> 
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                    <?php 
                    echo $this->Form->control('city', array('class'=>'form-control col-md-8 col-xs-12', 'placeholder' => '', 'label' => false, 'required' => 'required', 'id'=>'addresscity'));
                    ?>
                </div>
            </div>
        </div>
    ...
    <div class="row mt10">
        <div class="col-md-12">
            <div class="form-group"> 
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                    <?php 
                    echo $this->Form->control('country', array('options' => $countries, 'empty' => 'Select a country...', 'class' => 'form-control col-md-8 col-xs-12 selectpicker', 'data-show-subtext' => true, 'data-live-search' => true, 'label' => false, 'id' => 'addresscountry', 'required' => 'required')); 
                    ?>
                </div>
            </div>
        </div>
    ...
    <div class="row mt10">
        <div class="col-md-12">
            ...
            <div class="form-group addressprovinceblock" <?php if(!empty($stateblock)){ ?>style="display:none;"<?php } ?>> 
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                    <?php 
                    echo $this->Form->control('province', array('class'=>'form-control col-md-8 col-xs-12', 'placeholder' => '', 'label' => false, 'required' => 'required', 'id'=>'addressprovince'));
                    ?>
                </div>
            </div>
            ...
            <div class="form-group addressstateblock" <?php if(empty($stateblock)){ ?>style="display:none;"<?php } ?>> 
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                    <?php 
                    echo $this->Form->control('state', array('options' => $states, 'empty' => 'Select a state...', 'class' => 'form-control col-md-8 col-xs-12 selectpicker', 'data-show-subtext' => true, 'data-live-search' => true, 'label' => false, 'id' => 'addressstate'));
                    ?>
                </div>
            </div>
    ...
    <div class="row mt10">
        <div class="col-md-12">
            <div class="form-group"> 
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                    <?php 
                    echo $this->Form->input('postal', array('type'=>'number', 'class'=>'form-control col-md-8 col-xs-12', 'placeholder' => '', 'label' => false, 'required' => 'required', 'id'=>'addresspostal'));
                    ?>
                </div>
            </div>
        </div>
