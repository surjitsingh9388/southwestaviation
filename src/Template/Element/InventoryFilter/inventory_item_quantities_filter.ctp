...
<div class="modal-body" style="max-height: 500px; overflow-y: auto;">
    <?php echo $this->Form->create('', ['url' =>'', 'id' => 'frmInventoryQuantitiesFilter', 'autocomplete'=>'off']); ?>
                    ...
                    <div class="form-group"> 
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="is_active1">All</label>&nbsp;&nbsp;

                                <input class="form-check-input" type="radio" name="is_active" id="is_active2" value="2" checked>
                                <label class="form-check-label" for="is_active2">Yes</label>

                                <input class="form-check-input" type="radio" name="is_active" id="is_active3" value="3">
                                <label class="form-check-label" for="is_active3">No</label>&nbsp;&nbsp;
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-default clearinvitmquantitiesfilter">Clear</button>
        <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
        <button type="button" class="btn btn-primary applyinvqtyfilterbtn">Apply Filter</button>
    </div>
</div>