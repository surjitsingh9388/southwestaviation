                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td style="font-family: arial, verdana; font-size: 14px">
                                ...
                                <p style="padding: 0 0 5px 25px; margin:0">You have a new registration request. Below are the user's details:</p>
                                ...
                                <p style="padding: 0 0 5px 50px;margin:0">
                                    <strong>Home Airport:</strong> <?php echo $data['home_airport']; ?>
                                </p>
                                <p style="padding: 0 0 5px 50px;margin:0">
                                    <strong>Destination Airport:</strong> <?php echo $data['destination_airport']; ?>
                                </p>
                            </td>
                        </tr>
                        <tr>
