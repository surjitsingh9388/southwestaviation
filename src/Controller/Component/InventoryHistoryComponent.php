...
class InventoryHistoryComponent extends Component {
    ...
    public function saveInventoryLocationHistory($entity){
        ...
        $inventoryLocationHistory->user_id = $authUserData['id'];
    ...
    public function saveInventoryRequestHistory($entity){
        $InventoryRequestHistoriesModel = $this->getController()->fetchTable('InventoryRequestHistories');
        $InventoryRequestItemsModel = $this->getController()->fetchTable('InventoryRequestItems');
        $authUserData = $this->Authentication->getResult()->getData();
        ...
        $inventoryRequestHistory->user_id = $authUserData['id'];
    ...
    public function saveInventoryPurchaseOrderHistory($entity){
        $InventoryPurchaseOrderHistoriesModel = $this->getController()->fetchTable('InventoryPurchaseOrderHistories');
        $InventoryPOItemsModel = $this->getController()->fetchTable('InventoryPOItems');
        $authUserData = $this->Authentication->getResult()->getData();

        $inventoryPurchaseOrderHistory = $InventoryPurchaseOrderHistoriesModel->newEmptyEntity();
        ...
        $inventoryPurchaseOrderHistory->user_id = $authUserData['id'];
    ...
    public function saveInventoryRepairOrderHistory($entity){
        $InventoryRepairOrderHistoriesModel = $this->getController()->fetchTable('InventoryRepairOrderHistories');
        $InventoryROItemsModel = $this->getController()->fetchTable('InventoryROItems');
        $authUserData = $this->Authentication->getResult()->getData();

        $inventoryRepairOrderHistory = $InventoryRepairOrderHistoriesModel->newEmptyEntity();
        ...
        $inventoryRepairOrderHistory->user_id = $authUserData['id'];
    ...
    public function saveInventoryShippingOrderHistory($entity){
        $InventoryShippingOrderHistoriesModel = $this->getController()->fetchTable('InventoryShippingOrderHistories');
        ...
        $inventoryShippingOrderHistory->user_id = $authUserData['id'];
