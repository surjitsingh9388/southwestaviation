...
class InventoryComponent extends Component {
    ...
    public function getInventorySODetailsBySOId($id){
        ...
        $inventorysoitems = $InventoryShippingOrderItemsModel->find('all')->where(['InventoryShippingOrderItems.inventory_shipping_order_id'=>$id])->select($InventoryShippingOrderItemsModel)->select(['inv.id', 'inv.serial_no', 'invitms.name', 'invitms.part_number','invloc.location_name'])
        ->join([
            'inv' => [
                'table' => 'inventories',
                'type' => 'LEFT',
