...
class FlightlogComponent extends Component {
    public $components = ['User', 'Plane', 'Pilot', 'Timezone'];
    ...
    {
        $flModel = TableRegistry::get('Flightlogs');
        $res = $flModel->find() 
                        ->where([
                            'Flightlogs.id'=>$flid,
    ...
    public function flReportData($airId, $startDt, $endDt, $type)
    {
        ...
        if(!empty($airId) && !empty($startDt) && !empty($endDt)) {
            ...
            //Comp times
            $airCompTimeModel = TableRegistry::get('AirframeComponentTimes');
                ...
                foreach ($results as $key => $value) {
                    if(!empty($value) && count($value) < 8) {
                        ...
                        $flHtml .= '<tr class="flRow">
                                        ...
                                        <td colspan="9" style="text-align:left;line-height: 2.5;">'.$value['eng2Entry'].'</td>
                                        <td style="line-height: 2.5;">'.$value['airHr'].'</td>
                                        <td style="line-height: 2.5;">'.$value['airCy'].'</td>
                                        <td style="line-height: 2.5;">'.$value['eng1Hr'].'</td>
                                        <td style="line-height: 2.5;">'.$value['eng2Hr'].'</td>
                                        <td style="line-height: 2.5;">'.$value['eng1Cy'].'</td>
                                        <td style="line-height: 2.5;">'.$value['eng2Cy'].'</td>
                                    </tr>
                                    <tr class="flRow">
                                        <td style="line-height: 2.5;">'.$value['date'].'</td>
                                        <td colspan="9" style="text-align:left;line-height: 2.5;">'.$value['eng1Entry'].'</td>
                                        <td style="line-height: 2.5;">'.$value['airHr'].'</td>
                                        <td style="line-height: 2.5;">'.$value['airCy'].'</td>
                                        <td style="line-height: 2.5;">'.$value['eng1Hr'].'</td>
                                        <td style="line-height: 2.5;">'.$value['eng2Hr'].'</td>
                                    ...
                                    <tr class="flRow">
                                        <td style="line-height: 2.5;">'.$value['date'].'</td>
                                        <td colspan="9" style="text-align:left;line-height: 2.5;">'.$value['afEntry'].'</td>
                                        <td style="line-height: 2.5;">'.$value['airHr'].'</td>
                                        <td style="line-height: 2.5;">'.$value['airCy'].'</td>
                                        <td style="line-height: 2.5;">'.$value['eng1Hr'].'</td>
                                        <td style="line-height: 2.5;">'.$value['eng2Hr'].'</td>
