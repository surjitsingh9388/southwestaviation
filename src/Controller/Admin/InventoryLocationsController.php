<?php
    ...
    class InventoryLocationsController extends AppController
    {
        ...
        public function initialize():void {
            ...
            $this->InventoryLocationHistories = $this->fetchTable('InventoryLocationHistories');
        ...
        public function detail($id = null)
        {
            ...
            $inventorylocationhistories = $this->InventoryLocationHistories->find('all')
                                    ->where(['user_id'=>$authUserData['id'], 'inventory_location_id'=>$id])
        ...
        public function printQantitiesBarCode()
        {
            ...
            if($pagesizeval == '1'){
                ...
                $html .='<div style="clear:both;">
                            ...
                            <div>
                                <img src="'.BARCODEAPIURL.'chl=http%3A%2F%2Fwww.yahoo.com%2F" />
                            </div>
                        </div>';
                }        
                $html .='</div>    
