...
class LogbooksController extends AppController
{
    ...
    protected \App\Model\Table\SubComponentsTable $subCompObj;
    ...
    public function initialize():void 
    {
        ...
        $this->subCompObj = $this->fetchTable('SubComponents');
    }
    ...
    public function addItemDetails()
    {
        ...
        if(!empty($params['id']) && !empty($params['plane_id']) && !empty($params['nomenclature'])) {
            ...
            if (!empty($params['installed_date'])) {
                $params['installed_date'] = FrozenTime::createFromFormat('m/d/Y', $params['installed_date']);
            }
    
            if (!empty($params['last_inspection_date'])) {
                $params['last_inspection_date'] = FrozenTime::createFromFormat('m/d/Y', $params['last_inspection_date']);
            }  
            $logbook = $this->Logbooks->patchEntity($logbook, $params);
