...
class ReportsController extends AppController
{
    ...
    public function initialize() 
    {
        ...
        $this->extDetailObj      = TableRegistry::get('ExtraDetails');
        $this->parentChildRelObj = TableRegistry::get('ParentChildRelations');
        ...
        foreach ($reports as $key => $value) {
                    ...
                    <header>
                        <table id="header" style="width:100%; margin:0 auto; padding:0 0 10px 0; text-align:center;" cellspacing="0" cellpadding="0">
                            <tbody>
                                ...
                                <tr>
                                    <td style="width:6%; font-size:17px; font-weight: normal; text-align:left; padding:0 0 5px 0;">'.ucfirst($req['action']).'</td>
            ...
            $mResults .= '<table class="table table-bordered" cellpadding="0" cellspacing="0" style="width:100%; margin:0 auto; padding:0; border-collapse: collapse;border: 1px solid #c0c0c0; text-align:center;">
                ...
                $mResults .= '<th style="width:18%;font-size: 11px; font-family: Arial, Helvetica, sans-serif;font-weight: normal;padding: 2px;border: 1px solid #c0c0c0; margin: 0; background:#c0c0c0;">Description</th>
                        ...
                        <th style="width:9%;font-size: 11px; font-family: Arial, Helvetica, sans-serif;font-weight: normal;padding: 2px;border: 1px solid #c0c0c0; margin: 0; background:#c0c0c0;">TSN/TSO</th>
    ...
    public function displayGroupData($airPartsData, $req)
    {
        ...
        if(!empty($airPartsData) && !empty($req)) {
            foreach ($airPartsData as $key => $row) {
                ...
                if(!empty($remHrs)) {
                    $remMaint .= '<span style="'.$altHColor.'">Hours: '.round($remHrs,1).'</span><br>';
                }
        ...
        if(!empty($params['id'])) {
            ...
            foreach ($params['id'] as $key => $value) {
                ...
                if(!empty($results[$key]['hours']) && !empty($params['hhours'][$key])) {
                    ...
                    $results[$key]['hours_accrued'] = round($hours_accrued,1);
                }
            ...
            //Save extra details
            $data = array();
            $extDetail = $this->extDetailObj->newEntity();
            ...
            $data['date']      = date('Y-m-d');//Do not change date format here
            ...
            $airTHtml .='<div style="background: #fff;" class="formBGCls">
                <div style="border: 1px solid #c0c0c0;">
                    ...
                    <div style="width:100%;padding:10px 0 0 2px;float:left;" class="row">
                        <div style="width:10%; float:left;padding:5px;">Item Name</div>
                        <div id="textarea" style="width:62%; float:left;">'.$itemName.'</div>
                                ...
                                <div>
                                    ...
                                    <div class="itemInfoCls" style="width:100%;">
                                        ...
                                        <div class="itemCls" style="width:19%; float:left; padding:2px 2px 2px 8px;">
                                            ...
                                            <div class="form-group" style="padding-top:10px;">
                                                <div style="width:25%; float:left;padding:5px;">Hours</div>
                                                <div id="input" style="width:50%; float:left;">'.round($remHours,1).'</div>
                                                <div style="width:10%;">&nbsp;</div>
                                            </div>
            ...
            $airTHtml .='<div style="background: #fff;" class="formBGCls">
                <div>
                    ...
                    <div style="width:100%;padding:5px 0 0 2px;float:left;" class="row">
                        <div style="width:10%; float:left;padding:5px; font-size: 10px;">Item Name</div>
                        <div id="textarea" style="width:62%; float:left; font-size: 10px; font-size: 10px;">'.$itemName.'</div>
                        <div style="width:20%;">&nbsp;</div>
                    </div>
                                    ...
                                    <div class="itemInfoCls" style="width:100%;">
                                        <div class="itemCls" style="width:19%; float:left; padding:2px 2px 2px 2px;">
                                            ...
                                            <div class="form-group" style="padding-top:5px;"> 
                                                ...
                                                <div id="input" style="width:50%; float:left; font-size: 10px;">'.$lastCwDate.'</div>
                                                <div style="width:10%;">&nbsp;</div>
                                            </div>
                                        ...
                                        <div class="itemCls" style="width:19%; float:left; padding:2px 2px 2px 2px;">
                                            ...
                                            <div class="form-group" style="padding-top:5px;">
                                                <div style="width:25%; float:left;padding:3px; font-size: 10px;">Hours</div>
                                                <div id="input" style="width:50%; float:left; font-size: 10px;">'.round($remHours,1).'</div>
                                                <div style="width:10%;">&nbsp;</div>
                                            </div>
