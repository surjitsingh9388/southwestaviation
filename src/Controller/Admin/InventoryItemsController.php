<?php
    ...
    class InventoryItemsController extends AppController
    {
        ...
        protected \App\Model\Table\InventoryItemThresholdsTable $InventoryItemThresholds;
        ...
        public function initialize():void {
            ...
            $this->InventoryItemThresholds = $this->fetchTable('InventoryItemThresholds');
            ...
            $this->InventoryItemHistories = $this->fetchTable('InventoryItemHistories');
        ...
        public function create()
        {
            ...
            $invenotryitems = $this->InventoryItems->newEmptyEntity();
        ...
        public function detail($id = null)
        {
            ...
            $inventoryitemhistories = $this->InventoryItemHistories->find('all')
                                    ->where(['user_id'=>$authUserData['id'], 'inventory_item_id'=>$id])
        ...
        public function addThrashold($id=null)
        {
            ...
            $invenotryitemthresholds = $this->InventoryItemThresholds->newEmptyEntity();
            if ($this->request->is(['patch', 'post', 'put'])) {
                $postData = $this->request->getData();
                $postData['added_by'] = $authUserData['id'];
                $postData['updated_by'] = $authUserData['id'];
        ...
        public function printInventoryItemsBarCode()
        {
            ...
            <div class=container4>
                ...
                <span>
                    <img src="'.BARCODEAPIURL.'chl='.$invdetpageurl.'" />
                </span>
                </p>
            </div>        
            </body>
        ...
        public function saveInventoryItems(){
            if (!$this->request->is('ajax')) {
                ...
                $this->viewBuilder()->setLayout('ajax');
                $authUserData = $this->Authentication->getResult()->getData();
                $inventoryitems = $this->InventoryItems->newEmptyEntity();
                $authUserData = $this->Authentication->getResult()->getData();
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <table>
                                            ...
                                            <tr>
                                                <td colspan="2"></td>
                                                <td><img src="'.BARCODEAPIURL.'chl='.$invqty['bar_code'].'" /></td>
                                            </tr>
                                            <tr>
