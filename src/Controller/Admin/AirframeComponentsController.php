...
class AirframeComponentsController extends AppController
{
    ...
    public function ajaxManageComponentsSearch() {
        ...
        if(!empty($requestData['order'][1]['column'])){
            $sortby .= ', FIELD(AirframeComponents.log_book, "Aircraft", "Engine", "Propeller", "Air Conditioner", "Misc"), '.$columns[$requestData['order'][2]['column']].' '.$requestData['order'][2]['dir'];
        }
    ...
    public function add()
    {
        ...
        $airComp = $this->AirframeComponents->newEmptyEntity();
        if ($this->request->is('post')) {
            ...
            if ($this->AirframeComponents->save($airComp)) {
                ...
                $this->AircraftHistory->saveAirframeComponentHistory($airComp);
    ...
    public function getComponents() {
        ...
        if(!empty($this->request->getData()['source'])){
