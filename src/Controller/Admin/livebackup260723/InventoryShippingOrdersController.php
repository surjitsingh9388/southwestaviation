<?php
    ...
    class InventoryShippingOrdersController extends AppController
    {
        public function initialize() {
            ...
            $this->loadModel('InventoryShippingOrderItems');
            $this->loadModel('InventoryShippingOrderReceives');
            ...
            $this->loadModel('InventoryShippingOrderHistories');
        ...
        public function search()
        {
            ...
            $query['detail'] = "SELECT inv.id, inv.shipping_order_number, inv.reference, inv.requestor, inv.shipping_order_tax, inv.shipping_order_tax_amount, inv.shipping_order_additional_fees, inv.currency, inv.shipping_order_cost_total, inv.created, inv.shipping_order_status FROM `inventory_shipping_orders` as inv WHERE 1=1 ";
        ...
        public function ajaxInventoryShippingOrdersearch(){
            ...
            foreach ( $results as $row){//print_r($row);exit;
                ...
                }else if($row['shipping_order_status'] == '5'){
        ...
        public function edit($id = null)
        {
            ...
            $this->set(compact('InventoryShippingOrders', 'actionItems', 'countries', 'states', 'inventoryvendors', 'inventoryaddresses', 'to_address', 'from_address', 'vendor', 'InventoryShippingOrderItems', 'inventoryitems', 'location', 'attachments', 'invitmreceived'));
        }
        ...
        public function detail($id = null)
        {
            ...
            //echo "<pre>";print_r($InventoryShippingOrders);exit;
            $this->set(compact('InventoryShippingOrders', 'actionItems', 'InventoryShippingOrderItems', 'inventorybillingaddress', 'inventoryshippingaddress', 'countries', 'vendors', 'attachments', 'invitmreceived', 'inventorysoreceivedarr', 'states', 'inventorysohistories', 'linkorderdata'));
        }
        ...
        public function receive($inventory_shipping_order_id, $inventory_ro_item_id=null){
            ...
            $InventoryShippingOrderItems = $this->InventoryShippingOrderItems->find()->where($wherecond)->select($this->InventoryShippingOrderItems)->select(['invitms.id', 'invitms.name', 'invitms.part_number', 'invitms.is_this_item_serialized', 'inv.serial_no', 'inv.cost', 'inv.id'])
            ->join([
                'inv' => [
                    'table' => 'inventories',
                    'type' => 'LEFT',
