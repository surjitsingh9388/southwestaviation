<?php
    ...
    class InventoryRequestsController extends AppController
    {
        public function initialize() {
            ...
            $this->loadModel('InventoryRequestHistories');
        ...
        public function detail($id = null)
        {
            ...
            $this->set(compact('invenotryrequests', 'actionItems', 'inventoryrequestitems', 'inventoryitems', 'location', 'inventoryrequesthistories', 'linkorderdata'));
        }
