...
class FlightlogsController extends AppController
{
    ...
    public function dispatch($tripId=null, $legDate=null)
    {
        ...
        $this->set(compact('actionItems', 'fls', 'planes', 'pilotComp', 'tripId', 'legDate', 'tfcount'));
    }
    ...
    public function release($tripId=null)
    {
        ...
        //Pilot Component
        $pilotComp = $this->Pilot;
        $this->set(compact('actionItems', 'fls', 'planes', 'pilotComp', 'tfcount'));
    }
    ...
    public function flightlog($tripId=null)
    {
        ...
        if(!empty($tripId)) {
            ...
            foreach ($fls as $key=>$value) {
                ...
                if(strtotime($landing) < strtotime($takeOff)) {
                    $landing = "24:00";
                    $fltTime = $this->Pilot->addTimes(array($this->Pilot->timeDiffFL($takeOff, $landing), $landing));
                } else {
                    $fltTime = $this->Pilot->timeDiffFL($takeOff, $landing);
                }*/
                ...
                /*if(strtotime($taxiIn) < strtotime($taxiOut)) {
                    $taxiIn = "24:00";
                    $blkTime = $this->Pilot->addTimes(array($this->Pilot->timeDiffFL($taxiOut, $taxiIn), $taxiIn));
                } else {
                    $blkTime = $this->Pilot->timeDiffFL($taxiOut, $taxiIn);
                }*/
                $btArr = array(
                            'leg_date'=>$value['leg_date'],
                            'startTime'=>$taxiOut, 
        ...
        $this->set(compact('actionItems', 'fls', 'planes', 'pilotComp', 'timezoneComp', 'tfcount'));
    }
    ...
    public function updateCompTimes($flId, $data)
    {
        if(!empty($flId) && !empty($data['plane_id'])) {
            ...
            //$approaches = !empty($data['approaches']) ? $data['approaches'] : 0;

            $results = [];
            if(!empty($compDetails['airframe_components'])) {
                foreach ($compDetails['airframe_components'] as $key => $value) {
                    if(!empty($value['airframe_component_times'][0]['flightlog_id']) && $flId == $value['airframe_component_times'][0]['flightlog_id']) {
                        $results[$key]['id'] = $value['airframe_component_times'][0]['id'];
                        $compTimes = $this->airCompTimeObj->get($results[$key]['id']);
                    } else {
    ...
    public function getCrewList()
    {
        ...
        $crewHtml = '';
        if(!empty($allPilots)) {
            //$crewHtml = $this->Form->control('crew_member', array('options'=>$allPilots, 'class'=>'form-control col-md-6 col-xs-12 selectpicker changePilot', 'label'=>false));
    ...
    public function getBlockTime()
    {
        ...
        $finalTime = array();
        /*if(strtotime($params['taxiIn']) < strtotime($params['taxiOut'])) {
            $taxiIn = "24:00";
            //Time difference
            $blkTime = $this->Pilot->addTimes(array($this->Pilot->timeDiffFL($params['taxiOut'], $taxiIn), $params['taxiIn']));
        } else {
            //Time difference
            $blkTime = $this->Pilot->timeDiffFL($params['taxiOut'], $params['taxiIn']);
        }*/
        $btArr = array(
    ...
    public function getFlightTime()
    {
        ...
        $finalTime = array();
        /*if(strtotime($params['landing']) < strtotime($params['takeOff'])) {
            $landing = "24:00";
            //Time difference
            $fltTime = $this->Pilot->addTimes(array($this->Pilot->timeDiffFL($params['takeOff'], $landing), $params['landing']));
        } else {
            //Time difference
            $fltTime = $this->Pilot->timeDiffFL($params['takeOff'], $params['landing']);
        }*/
    ...
    public function displayCrewData()
    {
        ...
        if(!empty($params)) {
            ...
            $pilotFlying = !empty($params['pilot_flying']) ? $params['pilot_flying'] : '--';
            ...
            $crewHtml .= '<tr class="crewRecord'.$params['crew_member'].'">
                            ...
                            <td><input type="hidden" name="duty_on[]" value="'.$params['duty_on'].'">'.$params['duty_on'].'</td>
                            <td><input type="hidden" name="duty_off[]" value="'.$params['duty_off'].'">'.$params['duty_off'].'</td>
                        ...
                        foreach ($value['plane']['airframe_components'] as $key2 => $value2) {
                            if($key == 0) {
                                if($value2['log_book'] == 'Airframe') {
                                    $airHr = $value2['airframe_component_times'][0]['hours'];
                                    $airCy = $value2['airframe_component_times'][0]['cycles'];

                                } elseif($value2['log_book'] == 'Engine' && $value2['position'] == 1) {
                                    $eng1Hr = $value2['airframe_component_times'][0]['hours'];
                                    $eng1Cy = $value2['airframe_component_times'][0]['cycles'];

                                } elseif($value2['log_book'] == 'Engine' && $value2['position'] == 2) {
                                    $eng2Hr = $value2['airframe_component_times'][0]['hours'];
                                    $eng2Cy = $value2['airframe_component_times'][0]['cycles'];
                                }
                            } else {
                                if($value2['log_book'] == 'Airframe') {
                                    $airHr = $value2['airframe_component_times'][0]['hours'] - $prevTimeDecimal;
                                    $airCy = $value2['airframe_component_times'][0]['cycles'] - 1;

                                } elseif($value2['log_book'] == 'Engine' && $value2['position'] == 1) {
                                    $eng1Hr = $value2['airframe_component_times'][0]['hours'] - $prevTimeDecimal;
                                    $eng1Cy = $value2['airframe_component_times'][0]['cycles'] - 1;

                                } elseif($value2['log_book'] == 'Engine' && $value2['position'] == 2) {
                                    $eng2Hr = $value2['airframe_component_times'][0]['hours'] - $prevTimeDecimal;
                                    $eng2Cy = $value2['airframe_component_times'][0]['cycles'] - 1;
                                }
                            }
                        }
                    }
                ...
                $updHtml .= '<div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="duty_start_date" value="'.$record['duty_start_date'].'" class="form-control datePicker dtStartD">
                            </div> 
                        </div>
                        <div class="row">
                            <div class="col-md-12">
            ...
            if(!empty($record)) {
                ...
                $updHtml .= '<div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <label>Duty Start Date</label>
                                <input type="text" name="duty_start_date" value="'.date('d/m/Y', strtotime($record['duty_start_date'])).'" class="form-control datePicker dtStartD">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
            ...
            $manifHtml .= '<div class="row">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="max_weight" value="'.$max_weight.'" class="form-control" placeholder="0">
                        <input type="hidden" name="mf_id" value="'.$mf_id.'">
                    </div>

                    <div class="col-md-6">
                        <label>Actual T/O Weight</label>
                        <input type="text" name="actual_weight" value="'.$actual_weight.'" class="form-control" placeholder="0">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="forward_cg" value="'.$forward_cg.'" class="form-control" placeholder="0">
                    </div>

                    <div class="col-md-6">
                        <label>Actual CG</label>
                        <input type="text" name="actual_cg" value="'.$actual_cg.'" class="form-control" placeholder="0">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12" style="padding-top: 10px;">
                        ...
                        <input type="text" name="aft_cg" value="'.$aft_cg.'" class="form-control" placeholder="0">
                    </div>
                </div>';
    ...
    public function aircraftDueRecord()
    {
        ...
        if(!empty($params['airId'])) {
            $records = $this->Report->customReportQuery($params['airId']);
            $allResults = $this->Report->customReportWithCount($records, 'flightPage');
            //pr($allResults);die;
                        ...
                        foreach ($value2 as $key3 => $value3) {
                            if($i == 0) {
                                ...
                                if(!empty($value3['remAfl'])) {
                                    $remaining .= $value3['remAfl'].' cyc, ';
                                }

                                if(!empty($value3['totalRemD'])) {
                                    $remaining .= $value3['totalRemD'].' days';
                                }
            ...
            $result = array('status'=>'success', 'data'=>$extHtml, 'airitem'=>$airitem, 'airtogo'=>$airtogo);
            echo json_encode($result);die;
        } else {
