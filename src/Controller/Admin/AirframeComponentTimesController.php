...
class AirframeComponentTimesController extends AppController
{
    ...
    public function add()
    {
        ...
        $airCompTimes = $this->AirframeComponentTimes->newEmptyEntity();
        if ($this->request->is('post')) {
            ...
            if ($this->AirframeComponentTimes->save($airCompTimes)) {
                //save to airframe component time history table
                $this->AircraftHistory->saveAirframeComponentTimeHistory($airCompTimes);
