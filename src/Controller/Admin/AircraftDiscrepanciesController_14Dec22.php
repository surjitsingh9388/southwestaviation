...
class AircraftDiscrepanciesController extends AppController
{
    ...
    public function initialize() {
        ...
        $this->loadModel('AircraftDiscrepancies');
    }
    ...
    public function index($id = null)
    {
        ...
        $discrepResult = $this->AircraftDiscrepancies->find()
                            ->where([
                                    'AircraftDiscrepancies.plane_id'=>$id, 
                                    'AircraftDiscrepancies.discrepancy_corrected !='=>1
                                ])
    ...
    public function add()
    {
        ...
        if(!empty($params['disp_id'])) {
            ...
            $airDisc = $this->AircraftDiscrepancies->newEntity();
            $res = $this->AircraftDiscrepancies->saveData($airDisc, $params);
            if ($res) {
