...
/**
 * CustomerAircraftWOOSRPOReminders Model
 *
 ...
 */
class CustomerAircraftWOOSRPORemindersTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('customer_aircraft_wo_osr_po_reminders');
    ...
    public function beforeSave($options = array())
    {
        ...
        if (!empty($entity->notify_date_time)) {
            $entity->notify_date_time = $this->Planes->dateFormatBeforeSave($entity->notify_date_time);
        }
        return true;
    }
