...
class InventoryRepairOrdersTable extends Table
{
    ...
    public function beforeSave($options = array())
    {
        ...
        if(!empty($entity->ro_date)) {
            $entity->ro_date = $service->dateFormatBeforeSave($entity->ro_date);
        }

        if(!empty($entity->id)){
            $InventoryRepairOrdersModel =  FactoryLocator::get('Table')->get('InventoryRepairOrders');
            $inventoryrepairorders = $InventoryRepairOrdersModel->get($entity->id);
            $InventoryRepairOrderHistoriesModel =  FactoryLocator::get('Table')->get('InventoryRepairOrderHistories');
