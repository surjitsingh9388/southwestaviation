...
class InventoryPurchaseOrdersTable extends Table
{
    ...
    public function beforeSave($options = array())
    {
        ...
        if(!empty($entity->po_date)) {
            $entity->po_date = $service->dateFormatBeforeSave($entity->po_date);
        }
        
        if(!empty($entity->id)){
            $InventoryPurchaseOrdersModel =  FactoryLocator::get('Table')->get('InventoryPurchaseOrders');
            $inventorypurchaseorders = $InventoryPurchaseOrdersModel->get($entity->id);
            $InventoryPurchaseOrderHistoriesModel =  FactoryLocator::get('Table')->get('InventoryPurchaseOrderHistories');
