...
class LogbooksTable extends Table
{
    ...
    public function beforeSave($options = array())
    {
        ...
        if (!empty($entity->installed_date)) {
            $entity->installed_date = $service->dateFormatBeforeSave($entity->installed_date);
        }

        if (!empty($entity->last_inspection_date)) {
            $entity->last_inspection_date = $service->dateFormatBeforeSave($entity->last_inspection_date);
        }        
        return true;
    }
