...
class CustomerAircraftWOOptionTaxInfoesTable extends Table
{
    ...
    public function initialize(array $config):void
    {
        ...
        $this->setTable('customer_aircraft_wo_option_tax_infoes');
    ...
    public function beforeSave($options = array())
    {
        ...
        if(!empty($entity->id)){
            $CustomerAircraftWOOptionTaxInfoesModel =  FactoryLocator::get('Table')->get('CustomerAircraftWOOptionTaxInfoes');
            $aircraftwoitems = $CustomerAircraftWOOptionTaxInfoesModel->get($entity->id);
            ...
            $AircraftWOItemHistories->title = 'Item Tax Info was updated.';
