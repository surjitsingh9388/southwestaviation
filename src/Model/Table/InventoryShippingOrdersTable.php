...
class InventoryShippingOrdersTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ...
            ->notEmpty('shipping_order_number')
    ...
    public function beforeSave($options = array())
    {
        ...
        if(!empty($entity->shipping_order_date)) {
            $entity->shipping_order_date = $this->Planes->dateFormatBeforeSave($entity->shipping_order_date);
        }

        if(!empty($entity->id)){
            $InventoryShippingOrdersModel = TableRegistry::get('InventoryShippingOrders');
