            ...
            <div class="modal-body">
                <div class="row m-0">
                    <div class="col-lg-3 col-sm-6">
                        <h5 class="modalSubHeading">General Search Filters</h5>
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12 mt10">
                                <div class="form-group clearfix">
                                    <label class="control-label col-xs-5" for="reference">Primary Customer</label>
                                    <div class="col-xs-7">
                                        <?php
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 mt10">
                                <div class="form-group clearfix">
                                    <label class="control-label col-xs-5" for="reference">Reg. Number</label>
                                    <div class="col-xs-7">
                                        <?php
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 mt10">
                                <div class="form-group clearfix">
                                    <label class="control-label col-xs-5" for="reference">Make</label>
                                    <div class="col-xs-7">
                                        <?php
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 mt10">
                                <div class="form-group clearfix">
                                    <label class="control-label col-xs-5" for="reference">Model</label>
                                    <div class="col-xs-7">
                                        <?php
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 mt10">
                                <div class="form-group clearfix">
                                    <label class="control-label col-xs-5" for="reference">A/C Serial</label>
                                    <div class="col-xs-7">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 mt10">
                                <div class="form-group clearfix">
                                    <label class="control-label col-xs-5" for="reference">W/O or R/O</label>
                                    <div class="col-xs-7">
                                        <?php
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 mt10">
                                <div class="form-group clearfix">
                                    <label class="control-label col-xs-5" for="reference">Status</label>
                                    <div class="col-xs-7">
                                        <?php
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 mt10">
                                <div class="form-group clearfix">
                                    <label class="control-label col-xs-5" for="reference">Status Type</label>
                                    <div class="col-xs-7">
                                        <?php
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 mt10">
                                <div class="form-group clearfix">
                                    <label class="control-label col-xs-5" for="reference">Lead Tech</label>
                                    <div class="col-xs-7">
                                        <?php
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 mt10">
                                <div class="form-group clearfix">
                                    <label class="control-label col-xs-5" for="reference">Sales Person</label>
                                    <div class="col-xs-7">
                                        <?php
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 mt10">
                                <div class="form-group clearfix">
                                    <label class="control-label col-xs-5" for="reference">Misc. Charge Notes</label>
                                    <div class="col-xs-7">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12 mt10">
                                <div class="form-group clearfix">
                                    <label class="control-label col-xs-5" for="reference">
                                        Created From
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <h5 class="modalSubHeading">Item Filters</h5>
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12 mt10">
                                <div class="form-group clearfix">
                                    <label class="control-label col-xs-5" for="reference">ATA Code</label>
                                    <div class="col-xs-7">
                                        <?php
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 mt10">
                                <div class="form-group clearfix">
                                    <label class="control-label col-xs-5" for="reference">Category</label>
                                    <div class="col-xs-7">
                                        <?php
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 mt10">
                                <div class="form-group clearfix">
                                    <label class="control-label col-xs-5" for="reference">Department</label>
                                    <div class="col-xs-7">
                                        <?php
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 mt10">
                                <div class="form-group clearfix">
                                    <label class="control-label col-xs-5" for="reference">Grouping</label>
                                    <div class="col-xs-7">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 mt10">
                                <div class="form-group clearfix">
                                    <label class="control-label col-xs-5" for="reference">Labor Kit</label>
                                    <div class="col-xs-7">
                                        <?php
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 mt10">
                                <div class="form-group clearfix">
                                    <label class="control-label col-xs-5" for="reference">Warranty</label>
                                    <div class="col-xs-7">
                                        <?php
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 mt10">
                                <div class="form-group clearfix">
                                    <label class="control-label col-xs-5" for="reference">Warranty Claim No.</label>
                                    <div class="col-xs-7">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 mt10">
                                <div class="form-group clearfix">
                                    <label class="control-label col-xs-5" for="reference">Discrepancy</label>
                                    <div class="col-xs-7">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 mt10">
                                <div class="form-group clearfix">
                                    <label class="control-label col-xs-5" for="reference">Corrective Action</label>
                                    <div class="col-xs-7">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 mt10">
                                <div class="form-group clearfix">
                                    <label class="control-label col-xs-5" for="reference">Item Notes</label>
                                    <div class="col-xs-7">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 mt10">
                                <div class="form-group clearfix">
                                    <label class="control-label col-xs-5" for="reference">Item Status</label>
                                    <div class="col-xs-7">
                                        <?php
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 mt10">
                                <div class="form-group clearfix">
                                    <label class="control-label col-xs-5" for="reference">Signoff</label>
                                    <div class="col-xs-7">
                                        <?php
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 mt10">
                                <div class="form-group clearfix">
                                    <label class="control-label col-xs-5" for="reference">Signoff By</label>
                                    <div class="col-xs-7">
                                        <?php
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <h5 class="modalSubHeading">Service Info</h5>
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12 mt10">
                                <div class="form-group clearfix">
                                    <div class="col-xs-12 col-sm-12 col-md-7 col-md-offset-5">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 mt10">
                                <div class="form-group clearfix">
                                    <label class="control-label col-xs-5" for="reference">Service Technician</label>
                                    <div class="col-xs-7">
                                        <?php
                        ...
                        <h5 class="modalSubHeading">Tools</h5>
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12 mt10">
                                <div class="form-group clearfix">
                                    <div class="col-xs-12 col-sm-12 col-md-7 col-md-offset-5">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 mt10">
                                <div class="form-group clearfix">
                                    <label class="control-label col-xs-5" for="reference">Tool Name</label>
                                    <div class="col-xs-7">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 mt10">
                                <div class="form-group clearfix">
                                    <label class="control-label col-xs-5" for="reference">Tool Serial No.</label>
                                    <div class="col-xs-7">
                        ...
                        <h5 class="modalSubHeading">OSR Info</h5>
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12 mt10">
                                <div class="form-group clearfix">
                                    <div class="col-xs-12 col-sm-12 col-md-7 col-md-offset-5">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 mt10">
                                <div class="form-group clearfix">
                                    <label class="control-label col-xs-5" for="reference">Part Number</label>
                                    <div class="col-xs-7">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 mt10">
                                <div class="form-group clearfix">
                                    <label class="control-label col-xs-5" for="reference">Description</label>
                                    <div class="col-xs-7">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 mt10">
                                <div class="form-group clearfix">
                                    <label class="control-label col-xs-5" for="reference">Old Serial No.</label>
                                    <div class="col-xs-7">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 mt10">
                                <div class="form-group clearfix">
                                    <label class="control-label col-xs-5" for="reference">New Serial No.</label>
                                    <div class="col-xs-7">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 mt10">
                                <div class="form-group clearfix">
                                    <label class="control-label col-xs-5" for="reference">Vendor</label>
                                    <div class="col-xs-7">
                                        <?php
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <h5 class="modalSubHeading">Parts Info</h5>
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12 mt10">
                                <div class="form-group clearfix">
                                    <div class="col-xs-12 col-sm-12 col-md-7 col-md-offset-5">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 mt10">
                                <div class="form-group clearfix">
                                    <label class="control-label col-xs-5" for="reference">PO Number</label>
                                    <div class="col-xs-7">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 mt10">
                                <div class="form-group clearfix">
                                    <label class="control-label col-xs-5" for="reference">Supplier</label>
                                    <div class="col-xs-7">
                                        <?php
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 mt10">
                                <div class="form-group clearfix">
                                    <label class="control-label col-xs-5" for="reference">PO Vendor</label>
                                    <div class="col-xs-7">
                                        <?php
