<?php
echo $this->Form->create($aircraftwoitems, array('class' => '', 'id' => 'frmAircraftWorkOrderItems'));
...
<div class="row">
    <div class="col-md-2 col-sm-4 form-group">
        <label class="control-label" for="plane_id">Created By</label>
        <div>
            <?php
...
<div class="row">
    <div class="col-md-12 mt10">
        <div class="col-md-6">
            <?php if(!empty($signoffincompletes)){ ?>
            <span class="text-red">Sign-off Info:</span>
            <span><?php echo $signoffincompletes; ?> sign-offs are incomplete</span>
            <?php } ?>
        </div>
...
<script type="text/javascript">
    ...
    var validateWorkOrderACTTURL = "<?php echo $this->Url->build(['controller'=>'InventoryCustomers', 'action'=>'validateWorkOrderACTT']); ?>";
    var woItemOverviewWarrantyURL = "<?php echo $this->Url->build(['controller'=>'InventoryCustomers', 'action'=>'woItemOverviewWarranty']); ?>";
    var validateWOItemCorrectiveActionURL = "<?php echo $this->Url->build(['controller'=>'InventoryCustomers', 'action'=>'validateWOItemCorrectiveAction']); ?>";
</script>