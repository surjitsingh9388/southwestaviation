<div id="customerMediaUploadModel" class="modal fade page-content" role="dialog" style="background: transparent;">
    <div class="modal-dialog" style="width: 40%;">
        <?php
        echo $this->Form->create(null, array('class' => 'form-horizontal form-label-left', 'id' => 'frmInventoryCustomersMedia'));
        ?> 
        <div class="modal-content">
                ...
                <table class="table upload-area" id="uploadfile">
                    ...
                    <tbody id="filetbody">
                        ...
                        <tr>
                            ...
                            <?php
                            echo $this->Html->link($attachment['file_name'], '/inventorycustomers/' . $attachment['file_name'],['download'=>$attachment['file_name']]);
                            ?></td>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary saveCustomerInfoMedia">Save</button>
            </div>
        </div>
        <?php 
        echo $this->Form->end(); 
