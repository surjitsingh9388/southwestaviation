<div id="aircraftWOFileUploadModal" class="modal fade page-content" role="dialog" style="background: transparent;">
    <div class="modal-dialog" style="width: 30%;">
        <div class="modal-content">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <div id="upload-area" class="form-input-frame upload-area">
                                ...
                                <button type="button" id="uploadFileBtn" class="btn btn-primary btn-sm">Choose File</button>

                                <input type="file" name="files[]" id="aircraft_wo_files" class="hide-block" multiple  accept=".pdf, .doc, .docx, .xls, .xlsx" style="display:none;" />
                            </div>
                            <span id="importFileErrorMsg" style="color:red;"></span>
            ...
            <div class="modal-footer">
                ...
                <input type="button" value="Submit" class="btn btn-primary" id="uploadWOFileBtn">
            </div>
            <?= $this->Form->end() ?>
        </div>
    </div>
...
<script>
    $(document).ready(function() {
        //import excel code
        var fileInput = $("#aircraft_wo_files");
        ...
        function validateFile(file, fileInput) {
            ...
            if (!allowedExtensions.exec(file.name)) {
                $("#importFileErrorMsg").text("Only document files (.pdf, .doc, .docx, .xls, .xlsx) are allowed.");
