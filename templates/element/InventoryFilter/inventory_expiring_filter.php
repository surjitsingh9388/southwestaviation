<div class="modal-header" style="background-color: #e5e5e5;">
    ...
    <h4 class="modal-title"><span class="gpTypeCls"></span>Filter Physical Inventory</h4>
</div>
<div class="modal-body" style="max-height: 500px;">
    ...
    <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary applyExpfilterbtn">Apply Filter</button>
    </div>
</div>