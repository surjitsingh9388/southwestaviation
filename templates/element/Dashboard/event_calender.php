...
<div class="clearboth">
    ...
    <ol class="days list-unstyled">
        ...
        <li>
            ...
            ?>
            <div class="event dashboard_event_listing" event-description="<?php echo !empty($event['event_description']) ? $event['event_description'] : $event['event_name']; ?>" event-title="<?php echo $event['event_name']; ?>"><?php echo (strlen($event['event_name']) >= 30) ? substr($event['event_name'], 0, 30).'..' : $event['event_name'];?></div>
            <?php }}} ?>
        </li>
    <?php } ?>
    </ol>
