...
<div id="sidebar-menu" class="side-bar sliding">
    <ul style="max-height: calc(100vh - 57px); overflow-y: auto;">
        <div class="menu">
            ...
            if(in_array('User Management', $userMenu)) {
                ...
                ?>
                    ...
                    <ul class="nav dropdown-menu dropdown-usermenu" <?php echo $userStyle; ?>>
                        ...
                        if(in_array('PTO Request', $userMenu)) {
                            if ($controller == 'PtoRequests') { ?>
                            <li class="current-page">
                            <?php } else { ?>
                            <li>
                            <?php } ?>
                                <?php
                                    echo $this->Html->link("<i class='fa fa-calendar-times-o'></i> PTO Request", array('controller' => 'PtoRequests', 'action' => 'index'), array('escape' => false));
                                ?>
                            </li>
                        <?php 
                        }

                        if(in_array('User Department', $userMenu)) {
                            if ($controller == 'UserDepartments') { ?>
                            <li class="current-page">
                            <?php } else { ?>
                            <li>
                            <?php } ?>
                                <?php
                                    echo $this->Html->link("<i class='fa fa-building-o'></i> Department/Job Title", array('controller' => 'UserDepartments', 'action' => 'index'), array('escape' => false));
                                ?>
                            </li>
                        <?php 
                        }

                        if(in_array('Report', $userMenu)) {
                            if ($controller == 'HistoryReports') { ?>
                            <li class="current-page">
                            <?php } else { ?>
                            <li>
                            <?php } ?>
                                <?php
                                    echo $this->Html->link("<i class='fa fa-file-pdf-o'></i> Report", array('controller' => 'HistoryReports', 'action' => 'index'), array('escape' => false));
                                ?>
                            </li>
                        <?php 
                        }
                        
                        /*if(in_array('PTO Accrual Rate', $userMenu)) {
                            if ($controller == 'PtoRequests') { ?>
                            <li class="current-page">
                            <?php } else { ?>
                            <li>
                            <?php } ?>
                                <?php
                                    echo $this->Html->link("<i class='fa fa-calendar-times-o'></i> PTO Accrual Rate", array('controller' => 'PtoRequests', 'action' => 'pto_accrual_rate'), array('escape' => false));
                                ?>
                            </li>
                        <?php 
                        }*/
            ...
            if(in_array('Technical Publications', $userMenu)) {
                $techpublSubStyle = '';
                $technicalPublicationsSection = array('TechnicalPublicationSwas', 'TechnicalPublicationBvacs', 'TechnicalPublicationRjcs');
                ...
                ?>
                    ...
                    <ul class="nav dropdown-menu dropdown-usermenu" <?php echo $flightSubStyle; ?>>
                        ...
                        if(in_array('AD/SB Status', $userMenu)) {
                            ...
                            echo $this->Html->link("<i class=' fa fa-tasks'></i> <span>AD/SB Class</span>", 
                        ...
                        if(in_array('Positions', $userMenu)) {
                            ...
                            echo $this->Html->link("<i class='fa fa-tasks'></i> <span>Positions</span>", 
                ...
                ?>
                    ...
                    <ul class="nav dropdown-menu dropdown-usermenu" <?php echo $flightSubStyle; ?>>
                        ...
                        if(in_array('Due List', $userMenu)) {
                            ...
                            echo $this->Html->link(
                                "<i class='fa fa-tasks'></i> <span>Due List</span>", 
                                [
                                    'controller' => 'Reports', 
                                    'action' => 'maintenance', 
                                    '?' => ['type' => 'maintenance'] // Query string parameters
                                ], 
                                ['escape' => false]
                            );
                        ...
                        if(in_array('Settings', $userMenu)) {
                            ...
                            echo $this->Html->link("<i class='fa fa-cog'></i> <span>Settings</span>", array('controller' => 'Settings' ,'action' => 'index'), array('escape' => false));
                            ?>
                            </li>
                        <?php
                        }
...
function adjustSidebar() {
    ...
    if (isDesktop) {
        // Desktop → remove mobile-only classes
        if (sidebar) {
            sidebar.classList.remove('left');
        }
        if (content) {
            content.classList.remove('left', 'sliding');
        }
    } else {
        // Mobile → add mobile-only classes
        if (sidebar) {
