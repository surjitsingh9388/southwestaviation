<?php
echo $this->Form->create($inventorypurchaseorders, array('class' => '', 'id' => 'frmInventoryPurchaseOrders', 'autocomplete' => 'off'));
?>
...
<div style="padding:15px;">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="form-group  clearfix">
                ...
                <div >
                    ...
                    echo $this->Form->control('po_type', array('options' => $invPurchaseOrderType, 'empty' => 'Select type...', 'class' => 'form-control selectpicker', 'data-show-subtext' => true, 'data-live-search' => true, 'label' => false, 'id' => 'po_type', 'required' => 'required', 'value' => $po_type, $potypedisabled));  ?>
                </div>
            </div>
        </div>
    ...
    <div class="row mt10 customRow">
        <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="form-group  clearfix">
                ...
                <div>
                    <?php echo $this->Form->control('po_number', array('class' => 'form-control ', 'placeholder' => '', 'label' => false, 'required' => 'required', 'id' => 'po_number', 'value' => $po_number)); ?>
                </div>
            </div>
        </div>
    ...
    <!-- bills Row -->
        ...
        <!-- <div class="col-xs-4">
            <div class="form-group">
                ...
                <div class="col-md-7 col-sm-7 col-xs-12">
                    ...
                    ?>
                    <div class="col-md-1 col-sm-1 col-xs-12 plus-new-btn"><button class="btn btn-primary addnewinvaddresspopup" type="button" data-val="billing"><i class="fa fa-plus"></i></button></div>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="form-group  clearfix">
                <label class="control-label" for="bill_to_address">Bill To&nbsp;<span class="required">*</span></label>
                <div class="input-group inputWrap">
                    <?php
                    echo $this->Form->control('bill_to_address', [
                    ...
                    <span class="input-group-btn">
                        <button class="btn btn-primary addnewinvaddresspopup" type="button" data-val="billing">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="form-group  clearfix">
                ...
                <div class="input-group inputWrap">
                    <?php
                    echo $this->Form->control('ship_to_address', array('options' => $shippingaddress, 'empty' => 'Select Address...', 'class' => 'form-control  selectpicker', 'data-show-subtext' => true, 'data-live-search' => true, 'label' => false, 'id' => 'ship_to_address'));
                    ?>
                    <span class="input-group-btn"><button class="btn btn-primary addnewinvaddresspopup" type="button" data-val="shipping">
                            <i class="fa fa-plus"></i>
                        </button>
                    </span>
                </div>
...
<!-- requestor Row -->
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="form-group clearfix">
                ...
                <div>
                    <?php echo $this->Form->control('requestor', array('class' => 'form-control ', 'placeholder' => '', 'label' => false, 'value' => $userData['full_name'])); ?>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="form-group clearfix">
                ...
                <div class="input-group inputWrap">
                    ...
                    ?>
                     <span class="input-group-btn"><button class="btn btn-primary vendorModelbtn" type="button"><i class="fa fa-plus"></i></button></span>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="form-group clearfix">
                ...
                <div >
                    <?php
                    $sales_person = !empty($inventorypurchaseorders->sales_person) ? $inventorypurchaseorders->sales_person : $userData['full_name'];

                    echo $this->Form->control('sales_person', array('class' => 'form-control ', 'placeholder' => '', 'label' => false, 'value' => $sales_person));
                    ?>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="tab-content">
            <div id="itemGeneral" class="tab-pane fade in active"><!-- general-tab-section start -->
                <div class="g-0 bg-light position-relative table-responsive" style="overflow-x: auto;">
                        ...
                        <tbody>
                            ...
                            if (!empty($porequestid) || !empty($invitemid)) {
                                foreach ($inventorypoitems as $invreqitem) {
                                    ...
                                    if (!empty($invitemid)) {
                                        $subTotalAmount = isset($invreqitem->cost) ? $invreqitem->cost : '0.00';
                                    }
                                }
                            }
                                ...
                                <td colspan="4">
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="form-group mr-22 ml-22">
                                            <label class="control-label " for="plane_id"><span class="text-left">Tax</span> &nbsp;&nbsp;<input type="radio" name="po_tax" class="potaxcal" value="1" checked="checked"> %</label>
                                            <div >
                                                <?php echo $this->Form->control('po_tax_percentage', array('type' => 'number', 'class' => 'form-control', 'placeholder' => '', 'label' => false, 'value' => $po_tax_percentage)); ?>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-12 pr-0">
                                        <div class="form-group mr-22 ml-22">
                                            <label class="control-label " for="plane_id"><input type="radio" name="po_tax" class="potaxcal" value="0"> $</label>
                                            <div >
                                                <?php echo $this->Form->control('po_tax_amount', array('type' => 'number', 'class' => 'form-control', 'placeholder' => '', 'label' => false, 'disabled' => 'disabled', 'value' => $po_tax_amount)); ?>
                                            </div>
                                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo $this->Form->control('po_shipping', array('type' => 'number', 'class' => 'form-control col-md-6 col-xs-6', 'placeholder' => '', 'label' => false, 'value' => $po_shipping, 'id' => 'po-shipping')); ?>
                                </td>
                            </tr>
                            <tr>
                                <td></td>
