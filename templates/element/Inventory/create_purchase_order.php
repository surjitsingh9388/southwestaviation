...
<div class="addPartBorder">
    ...
    <div class="row">
        <div class="col-xs-4">
            <div class="form-group"> 
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                    <?php echo $this->Form->control('po_number', array('class'=>'form-control col-md-2 col-xs-12', 'placeholder' => '', 'label' => false, 'required' => 'required', 'id'=>'po_number', 'value'=>$po_number)); ?>
                </div>
            </div>
        </div>
        ...
        <div class="col-xs-4">
            <div class="form-group"> 
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                    ...
                    echo $this->Form->control('sales_person', array('class'=>'form-control col-md-2 col-xs-12', 'placeholder' => '', 'label' => false, 'value'=>$sales_person)); 
                    ?>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="form-group"> 
                <label class="control-label col-xs-4 special-instruction-label" for="plane_id">Special Instructions</label>
                <div class="col-xs-8">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="4">
                                    <div class="col-md-6">
                                        <div class="form-group"> 
                                            <label class="control-label col-md-6 col-sm-6 col-xs-12" for="plane_id" ><span class="text-left">Tax</span> &nbsp;&nbsp;<input type="radio" name="po_tax" class="potaxcal" value="1" checked="checked"> %</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <?php echo $this->Form->control('po_tax_percentage', array('type'=>'number', 'class'=>'form-control col-md-6 col-xs-12', 'placeholder' => '', 'label' => false, 'value'=>$po_tax_percentage)); ?>
                                            </div>
                                        </div>    
                                    </div>
