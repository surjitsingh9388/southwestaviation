        ...
        <div class="col-md-4">
            <div class="form-group"> 
                ...
                <div class="col-md-7 col-sm-7 col-xs-12">
                    ...
                    if(!isset($isdetailpage)){
                    ?>
                    <div class="col-md-1 col-sm-1 col-xs-12 plus-new-btn"><button class="btn btn-primary vendorModelbtn plus-btn-h" type="button"><i class="fa fa-plus"></i></button></div>
                    <?php } ?>
                </div>
            </div>
        </div>
                ...
                <div class="g-0 bg-light position-relative">
                    ...
                    <table class="table opinvitemtable">
                        ...
                        <tbody>
                            ...
                            $po_tax_percentage = isset($inventorypurchaseorders->po_tax_percentage) ? $inventorypurchaseorders->po_tax_percentage : 0;
                            $po_tax_amount = isset($inventorypurchaseorders->po_tax_amount) ? $inventorypurchaseorders->po_tax_amount : 0;
                            $po_shipping = isset($inventorypurchaseorders->po_shipping) ? $inventorypurchaseorders->po_shipping : 0;

                            $totalAmount = $subTotalAmount+$po_tax_amount+$po_shipping;
                            ?>
                            <tr id="invrequeststbl">
                                <td colspan="9">
                                    <a class="btn btn-primary addinvpoitem" data-val="invitem" <?php if(empty($inventorypoitems)){ ?>disabled <?php } ?>><i class="fa fa-plus-circle"></i> Add Inventory Item</a>
                                    <a class="btn btn-primary addinvpoitem" data-val="noninvitem"  <?php if(empty($inventorypoitems)){ ?>disabled <?php } ?>><i class="fa fa-plus-circle"></i> Add Non-Inventory Item</a>
                                </td>
                            </tr>
                            <tr>
                                <td></td>
                                ...
                                <td class="text-right"><span class="posubtotal"><?php echo $subTotalAmount; ?></span>&nbsp;<span class="pocurrency">USD</span></td>
                            </tr>
                            <tr>
                                <td></td>
                                <td></td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo $this->Form->control('po_shipping', array('type'=>'number', 'class'=>'form-control col-md-6 col-xs-6', 'placeholder' => '', 'label' => false, 'value'=>$po_shipping)); ?>
                                </td>
                            </tr>
                            <tr>
                                <td></td>
                                ...
                                <td colspan="7" class="text-right">
                                    ...
                                    <b class="totalpoamount"><?php echo $totalAmount; ?></b>&nbsp;<span class="pocurrency">USD</span>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table class="table upload-area tblinvpo" id="uploadfile">
                        ...
                        <tbody id="filetbody">
                            ...
                            <tr>
                                ...
                                <?php
                                echo $this->Html->link($attachment['file_name'], '/inventorypoitems/' . $attachment['file_name'],['download'=>$attachment['file_name']]);
                                ?></td>
