<div class="page-content">
    ...
    <div class="row">
        <div class="col-md-6 col-xs-12">
            ...
            <div class="form-group mt10 col-xs-12"> 
            ...
            <div class="invaddPageHeading mt10 col-xs-12" style="clear: both">Address Information</div>
            <div class="form-group mt10 col-xs-12"> 
            ...
            <div class="col-xs-12 mt10 " style="margin-bottom: 15px">
                <?php
                $stateblock = 1;
        ...
        <div class="col-md-6 col-xs-12">
            <div class="invaddPageHeading col-xs-12">Contact Information</div>
            <div class="form-group mt10 col-xs-12">
