        ...
        <div class="row">
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="form-group clearfix"> 
                    <label class="control-label col-sm-4 col-xs-12 p-0" for="plane_id">Location:</label>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="form-group clearfix">
                    <?php if($invenotries['_matchingData']['InventoryItems']['is_this_item_serialized'] == 1){ ?>
                        <label class="control-label col-md-4 col-sm-4 col-xs-12 p-0" for="airframe_component_id">Serial:</label>
                    <?php }else{ ?>
                        <label class="control-label col-md-4 col-sm-4 col-xs-12 p-0" for="airframe_component_id">Lot:</label>
                    <?php } ?>
                    <div class="col-md-8 col-sm-8 col-xs-12">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="form-group clearfix"> 
                    <label class="control-label col-md-4 col-sm-4 col-xs-12 p-0" for="plane_id">Display Name:</label>
                    <div class="col-md-8 col-sm-8 col-xs-12">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="form-group clearfix"> 
                    <label class="control-label col-md-4 col-sm-4 col-xs-12 p-0" for="plane_id">Cost:</label>
                    <div class="col-md-8 col-sm-8 col-xs-12">
                        <?php 
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="form-group clearfix"> 
                    <label class="control-label col-md-4 col-sm-4 col-xs-12 p-0" for="plane_id">Exchange Cost:</label>
                    <div class="col-md-8 col-sm-8 col-xs-12">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="form-group clearfix"> 
                    <label class="control-label col-md-4 col-sm-4 col-xs-12 label-cost p-0" for="plane_id">UOM:</label>
                    <div class="col-md-8 col-sm-8 col-xs-12">
                        <?php 
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="form-group clearfix"> 
                    <label class="control-label col-md-4 col-sm-4 col-xs-12 p-0" for="plane_id">Qty :</label>
                    <div class="col-md-8 col-sm-8 col-xs-12">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="form-group clearfix"> 
                    <label class="control-label col-md-4 col-sm-4 col-xs-12 p-0" for="plane_id">Barcode:</label>
                    <div class="col-md-8 col-sm-8 col-xs-12">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="form-group clearfix"> 
                    <label class="control-label col-md-4 col-sm-4 col-xs-12 p-0" for="plane_id">ATA Chapter:</label>
                    <div class="col-md-8 col-sm-8 col-xs-12">
                        <p class="form-control-static">
                            <?php
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="form-group clearfix"> 
                    <label class="control-label col-md-4 col-sm-4 col-xs-12 p-0" for="plane_id">Supplier:</label>
                    <div class="col-md-8 col-sm-8 col-xs-12">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="form-group clearfix"> 
                    <label class="control-label col-md-4 col-sm-4 col-xs-12 p-0" for="plane_id">Revision:</label>
                    <div class="col-md-8 col-sm-8 col-xs-12">
                        <p class="form-control-static">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="form-group clearfix"> 
                    <label class="control-label col-md-4 col-sm-4 col-xs-12 p-0" for="plane_id">Condition:</label>
                    <div class="col-md-8 col-sm-8 col-xs-12">
                            <?php 
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="form-group clearfix">
                    <label class="control-label col-md-4 col-sm-4 col-xs-12 p-0" for="plane_id">Warranty Exp.:</label>
                    <div class="col-md-8 col-sm-8 col-xs-12">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="form-group clearfix">
                    <label class="control-label col-md-4 col-sm-4 col-xs-12 p-0" for="plane_id">Expiration:</label>
                    <div class="col-md-8 col-sm-8 col-xs-12">
                        <p class="form-control-static">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                 <div class="form-group clearfix">
                    <label class="control-label col-md-4 col-sm-4 col-xs-12 p-0" for="plane_id">Received:</label>
                    <div class="col-md-8 col-sm-8 col-xs-12">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="form-group clearfix">
                    <label class="control-label col-md-4 col-sm-4 col-xs-12 p-0" for="plane_id">Exchange Price:</label>
                    <div class="col-md-8 col-sm-8 col-xs-12">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="form-group clearfix">
                    <label class="control-label col-md-4 col-sm-4 col-xs-12 p-0" for="plane_id">Retail Price:</label>
                    <div class="col-md-8 col-sm-8 col-xs-12">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="form-group clearfix">
                    <label class="control-label col-md-4 col-sm-4 col-xs-12 p-0" for="plane_id">Company Purchase Price:</label>
                    <div class="col-md-8 col-sm-8 col-xs-12">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="form-group clearfix">
                    <label class="control-label col-md-4 col-sm-4 col-xs-12 p-0" for="plane_id">Overhauled Cost:</label>
                    <div class="col-md-8 col-sm-8 col-xs-12">
                        <p class="form-control-static"><?php echo $invenotries['retail_price']; ?></p>
                    </div>
                </div>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="form-group clearfix"> 
                    <label class="control-label col-md-4 col-sm-4 col-xs-12 p-0" for="plane_id">Tag <i class="fa fa-info-circle" data-toggle="tooltip" title="This field can only be edited from the inventory item level"></i>:</label>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="form-group clearfix"> 
                    <label class="control-label col-md-4 col-sm-4 col-xs-12 p-0" for="plane_id">Capital Equipment?:<i class="fa fa-info-circle" data-toggle="tooltip" title="A capital item represents inventory in excess of a value to be determined by the operator."></i></label>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="form-group clearfix">
                    <label class="control-label col-md-4 col-sm-4 col-xs-12 p-0" for="airframe_component_id">Notes:</label>
                    <div class="col-md-8 col-sm-8 col-xs-12">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="form-group clearfix"> 
                    <label class="control-label col-md-4 col-sm-4 col-xs-12 p-0" for="plane_id">Tear Down Assest:</label>
