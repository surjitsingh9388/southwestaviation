...
<div class="addPartBorder hide-block" id="tab-<?php echo $start; ?>">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                <label class="control-label col-md-4 col-sm-4 col-xs-12" for="airframe_component_id">Qty</label>
                <div class="col-md-8 col-sm-8 col-xs-12" id="airCompsList">
                <?php echo $this->Form->control('qty[]', array('class'=>'form-control col-md-8 col-xs-12 serial_no', 'placeholder' => '', 'label' => false, 'id'=>'serial_no', 'value'=>$quantity)); ?>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-7 no-left-pad">
            <table class="table">
                <thead class="thead-dark">
                    <tr>
                        <th class="col-sm-2">Usage Times</th>
