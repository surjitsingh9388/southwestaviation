        ...
        <div class="col-md-9 col-sm-12">
            ...
            <div class="row">
                ...
                <div class="col-md-2 col-sm-4">
                    ...
                    <div class="form-group">
                        <div class="form-input-frame">
                            <?php echo $this->Form->control('aircraft_labor_discount_percentage', array('type'=>'text', 'class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'0.00%')); ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-2 col-sm-6">
                    ...
                    <div class="form-group">
                        <div class="form-input-frame">
                            <?php 
                            $aircraft_part_discount_percentage = !empty($customerotcaircrafts->aircraft_part_discount_percentage) ? $customerotcaircrafts->aircraft_part_discount_percentage.'%' : '';
                            echo $this->Form->control('aircraft_part_discount_percentage', array('type'=>'text', 'class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'0.00%', 'value'=>$aircraft_part_discount_percentage)); ?>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-12">
                    ...
                    <div class="form-group">
                        <div class="form-input-frame">
                            <?php 
                            $aircraft_use_specific_rate_hrs_val = !empty($customerotcaircrafts->aircraft_use_specific_rate_hrs_val) ? $customerotcaircrafts->aircraft_use_specific_rate_hrs_val.'%' : '';
                            echo $this->Form->control('aircraft_use_specific_rate_hrs_val', array('type'=>'text', 'class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'0.00%', 'value'=>$aircraft_use_specific_rate_hrs_val)); ?>
                        </div>
                    </div>
                </div>
