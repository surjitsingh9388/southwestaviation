    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="col-md-12">
                <div class="form-group">  
                    <label class="control-label col-md-4 " for="plane_id">Inspection Name</label>
                    <div class="col-md-5">
            ...
            <div class="col-md-12">
                <div class="form-group">  
                    <label class="control-label col-md-4" for="plane_id">Interval(Hour)</label>
                    <div class="col-md-5">
                        <?php
            ...
            <div class="col-md-12">
                <div class="form-group">  
                    <label class="control-label col-md-4" for="plane_id">Interval(Months)</label>
                    <div class="col-md-5">
                        <?php 
            ...
            <div class="col-md-12">
                <div class="form-group">  
                    <label class="control-label col-md-4" for="plane_id">Interval(Cycles)</label>
                    <div class="col-md-5">
                        <?php 
            ...
            <div class="col-md-12">
                <div class="form-group">  
                    <label class="control-label col-md-4" for="plane_id">Current AC Tach</label>
                    <div class="col-md-5">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    ?>
                    <label class="control-label col-md-4 due_next_landings_ac_tt" for="plane_id"><?php echo $inspections_duenextlandingacctt_h; ?></label>
                    <div class="col-md-5">
        ...
        <div class="col-md-6">
            <fieldset class="scheduler-border">
                ...
                <div class="col-md-12">
                    <div class="form-group">  
                        <label class="control-label col-md-4" for="plane_id">Inspection Code</label>
                        <div class="col-md-5">
                            <?php echo $this->Form->control('inspection_code', array('class'=>'form-control col-md-5', 'placeholder' => '', 'label' => false, 'id'=>'inspection_code')); ?>
                        </div>
                        <div class="col-md-3"></div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        ?>
                        <label class="control-label col-md-4 insp_current_ac_tach" for="plane_id"><?php echo $inspections_currentactach_h; ?></label>
                        <div class="col-md-5">
                            <?php echo $this->Form->control('insp_current_ac_tach', array('type'=>'number', 'class'=>'form-control col-md-5', 'placeholder' => '', 'label' => false, 'id'=>'insp_current_ac_tach')); ?>
                        </div>
                        <div class="col-md-3"></div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">  
                        <label class="control-label col-md-4" for="plane_id">Date Override</label>
                        <div class="col-md-5">
                            <div class="input-group date datePicker">
                                <?php 
                                $date_override = '';
            ...
            <div class="col-md-12">
                <div class="form-group">  
                    ...
                    <div class="form-input-frame">
                        <?php echo $this->Form->control('notes', array('type'=>'textarea', 'class' => 'form-control aircraft-notes', 'label'=> false, 'style'=>'width: 403px; height: 215px;', 'id'=>'insp_notes')); ?>
                    </div>
                </div>
            </div>
