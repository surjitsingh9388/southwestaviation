...
echo $this->Form->create(null, array('class' => 'form-horizontal form-label-left', 'id' => 'frmWOItemSignoffCategory'));
...
$signoff_category = !empty(@$signoffinspectioninfo['signoff_category']) ? @$signoffinspectioninfo['signoff_category'] : (!empty($signoff_category) ? $signoff_category : '');
$signoff_id = !empty(@$signoffinspectioninfo['id']) ? @$signoffinspectioninfo['id'] : '';
?> 
