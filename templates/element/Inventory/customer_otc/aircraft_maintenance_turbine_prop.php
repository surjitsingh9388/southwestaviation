<section class="top-form-section">
    ...
    <div class="row">
        ...
        <div class="col-md-2 col-6 col-xs-12">
            <div class="form-group">
                <label class="control-label" for="reference">TSPOH-#1</label>
            ...
            <div class="form-group">
                <label class="control-label" for="reference">TT-#1</label>
                <div class="form-input-frame">
            ...
            <div class="form-group">
                <label class="control-label" for="reference">Last Prop Bal-#1</label>
                <div class="form-input-frame">
   ...
   <div class="col-md-2 col-6 col-xs-12">
            <div class="form-group">
                <label class="control-label" for="reference">TSPOH-#2</label>
                <div class="form-input-frame">
                    <?php echo $this->Form->control('p_tspoh_r', array('type'=>'number', 'class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'', 'id'=>'p_tspoh_r')); ?>
                </div>
            </div>

            <div class="form-group">
                <label class="control-label" for="reference">TT-#2</label>
                <div class="form-input-frame">
                    <?php echo $this->Form->control('p_tt_r', array('type'=>'number', 'class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'', 'id'=>'p_tt_r')); ?>
                </div>
            </div>

            <div class="form-group">
                <label class="control-label" for="reference">Last Prop Bal-#2</label>
                <div class="form-input-frame">
                    <?php echo $this->Form->control('p_last_prop_bal_r', array('type'=>'number', 'class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'', 'id'=>'p_last_prop_bal_r')); ?>
                </div>
            </div>
        </div>
      ...
      <div class="col-md-2 col-6 col-xs-12">
            <div class="form-group">
                <label class="control-label" for="reference">O/H Date-#1</label>
                <div class="form-input-frame">
            ...
            <div class="form-group">
                <label class="control-label" for="reference">Model No.-#1</label>
                <div class="form-input-frame">
            ...
            <div class="form-group">
                <label class="control-label" for="reference">TSN-#1</label>
                <div class="form-input-frame">
     ...
     <div class="col-md-2 col-6 col-xs-12">
            <div class="form-group">
                <label class="control-label" for="reference">O/H Date-#2</label>
                <div class="form-input-frame">
                    <div class="input-group date datePicker">
                        <?php echo $this->Form->Text('p_oh_date_r', array('class' => 'form-control', 'id' => 'p_oh_date_r', 'placeholder' => '', 'label' => false)); ?>
                        <span class="input-group-addon">
                            <span class="glyphicon glyphicon-calendar"></span>
                        </span>
                    </div>
            ...
            <div class="form-group">
                <label class="control-label" for="reference">Model No.-#2</label>
                <div class="form-input-frame">
                    <?php echo $this->Form->control('p_model_no_r', array('class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'')); ?>
                </div>
            </div>

            <div class="form-group">
                <label class="control-label" for="reference">TSN-#2</label>
                <div class="form-input-frame">
                    <?php echo $this->Form->control('p_tsn_r', array('type'=>'number', 'class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'', 'id'=>'p_tsn_r')); ?>
                </div>
            </div>
        </div>
       ...
       <div class="col-md-2 col-6 col-xs-12">
            <div class="form-group">
                <label class="control-label" for="reference">Serial No.-#1</label>
                <div class="form-input-frame">
       ...
       <div class="col-md-2 col-6 col-xs-12">
            <div class="form-group">
                <label class="control-label" for="reference">Serial No.-#2</label>
                <div class="form-input-frame">
