        ...
        <div class="col-md-12">
            <fieldset class="scheduler-border">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-input-frame">
                        <?php echo $this->Form->control('use_special_rate_amount', array('type'=>'text', 'class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'', 'id'=>'use_special_rate_amount', 'value'=>$use_special_rate_amount)); ?>
                    </div>
                </div>
                <div class="col-md-8">
