<section class="top-form-section">
    <div class="row">
        <div class="col-md-12">
            <div class="btn-group">
                ...
                <button type="button" class="btn btn-default wo-item-remove-part-btn" <?php if($aircraftwoitems->wo_item_status == '3'){ ?> disabled<?php } ?>>Remove Part</button>
    ...
    <div class="row">
        <div class="col-md-12 mt10 wo_item_parts_list">
            <table class="table table-bordered">
                <thead>
                    <tr>
                        ...
                        <th scope="col">Reqeust Number</th>
...
<script>
    ...
    var removeWOItemPartsURL = "<?php echo $this->Url->build(['controller'=>'InventoryCustomers', 'action'=>'removeWOItemParts']); ?>";
</script>