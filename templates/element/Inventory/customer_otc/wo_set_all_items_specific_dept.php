<div id="woSetAllItemsSpecificDeptModal" class="modal fade page-content" role="dialog" style="background: transparent;">
    <div class="modal-dialog" style="width: 40%;">
        <?php
        echo $this->Form->create(null, array('class' => 'form-horizontal form-label-left', 'id' => 'frmAircraftContractRate'));
        ?> 
                    ...
                    <div class="col-md-12">
                        <div class="form-group"> 
                            ...
                            <div class="col-md-8">
                                ...
                                echo $this->Form->control('contract_rate_department', array('options' => $contractRateDepartment, 'empty' => 'Select', 'class' => 'form-control col-md-8 col-xs-12 selectpicker', 'data-show-subtext' => true, 'data-live-search' => true, 'label' => false, 'id' => 'contract_rate_department_new'));
                                ?>
                            </div>
                        </div>
                    </div>
