<section class="top-form-section aricraftcomplengblock">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="col-md-12">
                <div class="form-group">  
                    <label class="control-label col-md-4 " for="plane_id">Name</label>
                    <div class="col-md-8">
            ...
            <div class="col-md-12">
                <div class="form-group">  
                    <label class="control-label col-md-4" for="plane_id">Part Number</label>
                    <div class="col-md-8">
            ...
            <div class="col-md-12">
                <div class="form-group">  
                    <label class="control-label col-md-4" for="plane_id">Time Limit of Part</label>
                    <div class="col-md-5">
            ...
            <div class="col-md-12">
                <div class="form-group">  
                    <label class="control-label col-md-4" for="plane_id">Cycle Limit of Part</label>
                    <div class="col-md-5">
                        <?php echo $this->Form->control('cycles_limit_of_part', array('type'=>'number', 'class'=>'form-control col-md-5', 'placeholder' => '', 'label' => false, 'id'=>'engine_cycles_limit_of_part')); ?>
                    </div>
            ...
            <div class="col-md-12">
                <div class="form-group">  
                    <label class="control-label col-md-4" for="plane_id">Time at Install</label>
                    <div class="col-md-5">
                        <?php echo $this->Form->control('time_at_install', array('class'=>'form-control col-md-5', 'placeholder' => '', 'label' => false, 'id'=>'engine_time_at_install')); ?>
                    </div>
                    <div class="col-md-3"></div>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="form-group">  
                    <label class="control-label col-md-4" for="plane_id">Cycle at Install</label>
                    <div class="col-md-5">
                        <?php echo $this->Form->control('interval_cycles', array('type'=>'number', 'class'=>'form-control col-md-5', 'placeholder' => '', 'label' => false, 'id'=>'engine_cycles_at_install')); ?>
                    </div>
                    <div class="col-md-3"></div>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="form-group">  
                    <label class="control-label col-md-4" for="plane_id">Eng TT at Install</label>
                    <div class="col-md-5">
                        <?php echo $this->Form->control('current_ac_tach', array('type'=>'number', 'class'=>'form-control col-md-5', 'placeholder' => '', 'label' => false, 'id'=>'engine_eng_tt_at_install')); ?>
                    </div>
                    <div class="col-md-3"></div>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="form-group">  
                    <label class="control-label col-md-4" for="plane_id">Eng Cycle at Inst.</label>
                    <div class="col-md-5">
                        <?php echo $this->Form->control('current_ac_tach', array('type'=>'number', 'class'=>'form-control col-md-5', 'placeholder' => '', 'label' => false, 'id'=>'engine_eng_cycle_at_install')); ?>
                    </div>
                    <div class="col-md-3"></div>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="form-group">  
                    <label class="control-label col-md-4" for="plane_id">Due (Date)</label>
                    <div class="col-md-5">
            ...
            <div class="col-md-12">
                <div class="form-group">  
                    <label class="control-label col-md-4" for="plane_id"></label>
                    <div class="col-md-8">
                        <?php
                        $enguse_due_datechk = '';
            ...
            <div class="col-md-12">
                <div class="form-group">  
                    <label class="control-label col-md-4" for="plane_id">Due (Hours)</label>
                    <div class="col-md-8">
            ...
            <div class="col-md-12">
                <div class="form-group">  
                    <label class="control-label col-md-4" for="plane_id">Due (Cycle)</label>
                    <div class="col-md-8">
            ...
            <div class="col-md-12">
                <div class="form-group">  
                    <label class="control-label col-md-4" for="plane_id">Due Next - Eng TT</label>
                    <div class="col-md-5">
            ...
            <div class="col-md-12">
                <div class="form-group">  
                    <label class="control-label col-md-4" for="plane_id">Due Next - Cycles</label>
                    <div class="col-md-5">
            ...
            <div class="col-md-12">
                <div class="form-group">  
                    <label class="control-label col-md-4" for="plane_id">Time on Part</label>
                    <div class="col-md-5">
            ...
            <div class="col-md-12">
                <div class="form-group">  
                    <label class="control-label col-md-4" for="plane_id">Cycle on Part</label>
                    <div class="col-md-5">
        ...
        <div class="col-md-6">
            <div class="col-md-12">
                <div class="form-group">  
                    <label class="control-label col-md-4" for="plane_id">ATA Code</label>
                    <div class="col-md-8">
            ...
            <div class="col-md-12">
                <div class="form-group">  
                    <label class="control-label col-md-4" for="plane_id">Engine</label>
                    <div class="col-md-5">
                        <?php
                        $engineArr = ['1'=>'Left'];
                        echo $this->Form->control('engine', array('options' => $engineArr, 'empty' => '', 'class' => 'form-control col-md-5 selectpicker', 'data-show-subtext' => true, 'data-live-search' => true, 'label' => false, 'id' => 'engine_eng', 'disabled'=>'disabled'));
                        ?>
                    </div>
                    <div class="col-md-3"></div>
                </div>
            ...
            <div class="col-md-12">
                <div class="form-group">  
                    <label class="control-label col-md-4" for="plane_id">Type</label>
                    <div class="col-md-5">
                        <?php
            ...
            <div class="col-md-12">
                <div class="form-group">  
                    <label class="control-label col-md-4" for="plane_id">Serial Number</label>
                    <div class="col-md-8">
            ...
            <div class="col-md-12">
                <div class="form-group">  
                    <label class="control-label col-md-4" for="plane_id">Date Installed</label>
                    <div class="col-md-8">
                        <div class="input-group date datePicker">
            ...
            <div class="col-md-12">
                <div class="form-group">  
                    <label class="control-label col-md-4" for="plane_id">AC TT at Installed</label>
                    <div class="col-md-5">
            ...
            <div class="col-md-12">
                <div class="form-group">  
                    <label class="control-label col-md-4" for="plane_id">Tach Correction</label>
                    <div class="col-md-5">
            ...
            <div class="col-md-12">
                <div class="form-group">  
                    <label class="control-label col-md-4" for="plane_id">AC Tach at Installed</label>
                    <div class="col-md-5">
            ...
            <div class="col-md-12">
                <div class="form-group">  
                    <label class="control-label col-md-4" for="plane_id">Current Eng TT</label>
                    <div class="col-md-5">
            ...
            <div class="col-md-12">
                <div class="form-group">  
                    <label class="control-label col-md-4" for="plane_id">Current Eng Cycles</label>
                    <div class="col-md-5">
            ...
            <div class="col-md-12">
                <div class="form-group">  
                    ...
                    <div class="form-input-frame">
                        <?php echo $this->Form->control('notes', array('type'=>'textarea', 'class' => 'form-control aircraft-notes', 'label'=> false, 'style'=>'width: 395px; height: 220px;', 'id'=>'engine_notes')); ?>
                    </div>
                </div>
            </div>
        </div>
