<section class="top-form-section">
    <?php
    echo $this->Form->create($aircraftwologbookvaloverview, array('class' => 'form-horizontal form-label-left', 'id' => 'frmAircraftWOLogBookValOverview', 'autocomplete' => 'off'));
    ?>
    <div class="row">
        ...
        <input type="hidden" name="logbook_value_overview_id" id="logbook_value_overview_id" value="<?php echo @$aircraftwologbookvaloverview->id; ?>" />
        ...
        <div class="col-md-2">
            ...
            <div class="form-group">
                ...
                if(!empty($aircraftwologbookvaloverview->tach_is_flight_time)){
                    $current_ac_tach_h = 'A/C FlightTime';
                }
                $current_ac_tach_readonly = '';
                if(!empty($aircraftwologbookvaloverview->use_hobbs)){
        ...
        <div class="col-md-2">
            ...
            <div class="form-group">
                ...
                <div class="form-input-frame">
                    <?php echo $this->Form->control('heater_hobbs', array('type'=>'number', 'class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'', 'id'=>'maint_heater_hobbs')); ?>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-2">
            ...
            <div class="form-group">
                ...
                <div class="form-input-frame">
                    <div class="input-group date datePicker">
                        <?php echo $this->Form->Text('last_oil_chg_date', array('class' => 'form-control', 'id' => 'maint_last_oil_change_date', 'placeholder' => '', 'label' => false)); ?>
                        <span class="input-group-addon">
                            <span class="glyphicon glyphicon-calendar"></span>
                        </span>
                    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <button type="button" class="btn btn-primary saveAircraftWOLogBookValOverviewBtn float-right">Save</button>
        </div>
    </div>
    <?php 
    echo $this->Form->end(); 
