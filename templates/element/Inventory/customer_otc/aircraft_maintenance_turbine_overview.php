<section class="top-form-section">
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            ...
            <div class="form-group">
                ...
                <div class="form-input-frame">
                    <?php echo $this->Form->control('airframe_tt', array('type'=>'number', 'class' => 'form-control', 'label' => false, 'autocomplete'=>'off', 'placeholder'=>'', 'id'=>'maint_airframe_tt')); ?>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            ?>
            <button type="button" class="btn btn-primary <?php echo $btnclass; ?> float-right" <?php echo $isdisabled; ?> <?php echo $isdisabled; ?>>Save</button>
        </div>
    </div>
    <?php 
    echo $this->Form->end(); 
