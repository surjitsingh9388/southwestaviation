<div class="addPartBorder">
    ...
    <div class="row mt10">
        <div class="col-md-6">
            <div class="form-group"> 
                <label class="control-label col-md-2" for="plane_id">Location:&nbsp;<span class="required">*</span></label>
                <div class="col-md-10">
                    <?php
        ...
        <div class="col-md-6">
            <div class="form-group">
                <?php if($invenotryitems->is_this_item_serialized == 1){ ?>
                    <label class="control-label col-md-2" for="airframe_component_id">Serial:&nbsp;<span class="required">*</span></label>
                    <div class="col-md-10" id="airCompsList">
                    <?php echo $this->Form->control('serial_no', array('class'=>'form-control col-md-10', 'placeholder' => '', 'label' => false, 'required' => 'required', 'id'=>'serial_no')); ?>
                    </div>
                <?php }else{ ?>
                    <label class="control-label col-md-2" for="airframe_component_id">Lot:</label>
                    <div class="col-md-10" id="airCompsList">
                    <?php echo $this->Form->control('serial_no', array('class'=>'form-control col-md-10', 'placeholder' => '', 'label' => false, 'id'=>'serial_no')); ?>
                    </div>
                <?php } ?>
        ...
        <div class="col-md-6">
            <div class="col-md-6">
                <div class="form-group"> 
                    ...
                    <div class="col-md-8 col-sm-8" id="airCompsList" style="padding-left: 7px;">
            ...
            <div class="col-md-4">
                <div class="form-group"> 
                    ...
                    <div class="col-md-8" id="airCompsList">
                        ...
                        $cost = !empty($cost) ? '$'.$cost : '$0.00';
                        echo $this->Form->control('cost', array('type'=>'text', 'class'=>'form-control col-md-8', 'placeholder' => '$0.00', 'label' => false, 'value'=>$cost, 'id'=>'inventory_cost')); ?>
                    </div>
                </div>
            </div>
            <div class="col-md-2">
        ...
        <div class="col-md-6">
            ...
            <?php if(!isset($action)){ ?>
                <div class="col-md-4" style="padding-right: 0px;">
                    <div class="form-group"> 
                        <label class="control-label col-md-6" for="plane_id">Exchange Cost:</label>
                        
                        <div class="col-md-6" id="airCompsList" style="padding-left: 5px;">
                            <?php 
                            $exchange_cost = !empty($invenotries->exchange_cost) ? $invenotries->exchange_cost : $invenotryitems->exchange_cost;
                            $exchange_cost = !empty($exchange_cost) ? '$'.$exchange_cost : '$0.00';
            ...
            <?php if($invenotryitems->is_this_item_serialized == 0){ ?>
                <div class="col-md-4" style="padding-left:0px;">
                    <div class="form-group"> 
                        ...
                        <div class="col-md-8" id="airCompsList" style="padding-left: 20px; padding-right: 0px;">
                            <?php echo $this->Form->control('qty', array('class'=>'form-control col-md-8', 'placeholder' => '0.00', 'label' => false, 'id'=>'inventory_qty')); ?>
                        </div>
                    </div>
                </div>
            <?php }else{ ?>
                ...
                <div class="col-md-12">
                    <div class="form-group"> 
                        ...
                        <div class="col-md-8" id="airCompsList">
                            ...
                            $exchange_cost = !empty($invenotries->exchange_cost) ? $invenotries->exchange_cost : $invenotryitems->exchange_cost;
                            $exchange_cost = !empty($exchange_cost) ? '$'.$exchange_cost : '$0.00';
                            echo $this->Form->control('exchange_cost', array('type'=>'text', 'class'=>'form-control col-md-8', 'placeholder' => '$0.00', 'label' => false, 'value'=>$exchange_cost, 'id'=>'exchange_cost')); ?>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-6">
            <div class="col-md-6">
                <div class="form-group"> 
                    ...
                    <div class="col-md-8" id="airCompsList" style="padding-left: 7px;">
        ...
        <div class="col-md-6">
            <div class="col-md-6">
                <div class="form-group"> 
                    ...
                    <div class="col-md-6" id="airCompsList" style="padding-right:0px; padding-left: 5px;">
                        <?php 
                    ...
                    <div class="col-md-1 plus-new-btn vendor-add-btn" style="float: left;margin-top: 0px;padding-left: 0px;margin-left: 0px;"><button class="btn btn-primary vendorModelbtn" type="button"><i class="fa fa-plus"></i></button></div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group"> 
                    <label class="control-label col-md-4 label-cost" for="plane_id" >Revision:</label>
        ...
        <div class="col-md-6">
            <div class="col-md-6">
                <div class="form-group"> 
                    ...
                    <div class="col-md-8" id="airCompsList" style="padding-left: 5px;">
                        <div class="input-group date datePicker">
    ...
    <div class="row mt5">
        <div class="col-md-6">
            <div class="form-group"> 
                <label class="control-label col-md-2" for="plane_id">Exchange Price:</label>
                <div class="col-md-10">
                    <?php 
                    $exchange_price = '';
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label class="control-label col-md-2" for="airframe_component_id">Retail Price:</label>
                <div class="col-md-10" id="airCompsList">
                    <?php 
                    $retail_price = '';
    ...
    <div class="row mt5">
        <div class="col-md-6">
            <div class="form-group"> 
                <label class="control-label col-md-2" for="plane_id">Company Purchase Price:</label>
                <div class="col-md-10">
                    <?php 
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label class="control-label col-md-2" for="airframe_component_id">Overhauled Cost:</label>
                <div class="col-md-10" id="airCompsList">
                    <?php 
                    $overhauled_cost = '';
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group"> 
                <label class="control-label col-md-2" for="plane_id">Tag <i class="fa fa-info-circle" data-toggle="tooltip" title="This field can only be edited from the inventory item level"></i>:</label>
        ...
        <div class="col-md-6">
            <div class="form-group"> 
                <label class="control-label col-md-2" for="plane_id">Capital Equipment?:<i class="fa fa-info-circle" data-toggle="tooltip" title="A capital item represents inventory in excess of a value to be determined by the operator."></i></label>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                <label class="control-label col-md-2" for="airframe_component_id">Notes:</label>
                <div class="col-md-10">
        ...
        <div class="col-md-6">
            <div class="form-group"> 
                <label class="control-label col-md-2" for="plane_id">Tear Down Assest:</label>
