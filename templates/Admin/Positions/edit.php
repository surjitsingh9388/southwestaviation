                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <?php echo $this->Form->control('title', array('class' => 'form-control col-md-7 col-xs-12', 'placeholder' => 'Position', 'label' => false, 'required' => 'required')); ?>
                            </div>
                        </div>
...
$(document).ready(function() {
    $('#frmPositionId select.selectpicker').on('change', function(e) {
