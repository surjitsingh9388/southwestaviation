...
<script type="text/javascript">
    function action(e){
        ...
        if(confirm(msg)){
            ...
            var city_id = $(e).attr("data-city_id");
            $("#actionForm").attr("action",url);
            $("#actionForm").append("<input type='hidden' name='id' value='"+city_id+"'/>");
             $("#actionForm").submit();
         }
         return false;  
    }
    $(document).ready(function() {
        var dataTable = $('#datatable').DataTable( {
            ...
            "ajax":{
                ...
                url:"<?php echo $this->Url->build(['controller'=>'Cities', 'action'=>'ajaxManageCitiesSearch']); ?>",
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    ...
                    echo $this->Html->link("<i class='fa fa-plus'></i> Add City", array('action' => 'add'), array('class' => 'btn btn-primary pull-right', 'escape' => false));
                    }
                    ?>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    <table id="datatable" class="table table-striped table-bordered table-hover">
                        <thead>
                            <tr>
                                <th width="5%">#</th>
                                <th width="13%"><?php echo __('City Name'); ?></th>
                                <th width="20%"><?php echo __('State Name'); ?></th>
                                <th width="8%"><?php echo __('Country Name'); ?></th>
