                    ...
                    <div class="">
                        <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <p class="form-control-static reference-white-space"><?php echo $inventorypurchaseorders->reference; ?></p>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <p class="form-control-static"><?php echo $inventorypurchaseorders->sales_person; ?></p>
                                </div>
                            </div>
    ...
    <div class="modal-dialog" style="width: 40%; height:auto;">
        <div class="modal-content">
            ...
            <div class="modal-body" style="max-height: auto; overflow-y: auto;">
                <?php echo $this->Form->create(null, ['url' =>['controller'=>'InventoryPurchaseOrders', 'action'=>'updatePOExchangeStatus'], 'id' => 'frmInventoryPOExchangeStatus', 'autocomplete'=>'off']); ?>
