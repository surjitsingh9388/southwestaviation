...
<div class="content sliding" style="position:fixed;">
    <div class="outerWrapper">
        <div class="btnWrapper maintenanceHeader">
            <h2 class="heading">
                <?php
                                ...
                                <div class="modal-content">
                                    <form id="aircraftDetailForm" action="maintenance">
                                        <div style="max-height: 340px; overflow-y: auto;">
                                            <table id="aircraftUtilization" class="table table-hover table-header-dark table-striped table-bordered table-responsive">
                                                <thead>
                                                    <tr>
                                                        <th width="10%"><input type="checkbox" name="aircraft_info" id="airCheckAll" <?php if (count($allAircraft) == $airChkCnt) {
                                                                                                                                            echo "checked";
                                                                                                                                        } ?>></th>
                                                ...
                                                ?>
                                                        <div class="item <?php echo $active; ?>">
                                                            ...
                                                            <div class="" style="height: 400px; overflow-y: auto; width: 100%;">
                                                                ...
                                                                <table class="table table-hover table-header-dark table-striped table-bordered table-responsive">
                                                                    <thead>
                                                                        <tr>
                                                                            <th width="18%" class="text-nowrap">Equipment</th>
                                                                            <th width="30%" class="text-nowrap">Model</th>
                                                                            <th width="10%" class="text-nowrap">Serial</th>
                                                                            <th width="13%" class="text-nowrap">Report Date</th>
                                                                            <th width="13%" class="text-nowrap">Reported By</th>
                                                                            <th width="8%" class="text-nowrap">Hours</th>
                                                                            <th width="8%" class="text-nowrap">Cycles</th>
                                                                        </tr>
                                                                    </thead>
                                                                    <tbody>
                                                                        <?php
                    ...
                    <table id="customReport" class="table mb-0">
                        <thead>
                            <tr>
                                ...
                                <th width="20%" class="order text-nowrap" data-datasort="1" data-titlen="description">Description</th>
                                ...
                                <th width="0%" class="text-nowrap"></th>
                                <th width="0%" class="text-nowrap"></th>
                            </tr>
                        </thead>
