            ...
            <div class="formBGCls formInfoComponent">
                <div class="addPartBorder">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="col-md-5" style="padding-left: 11px;padding-right: 0px;width: 220px;">
                ...
                <div class="addPartBorder">
                    <div class="corrPageHeading">
                        ...
                        <div class="corrPH">Next Due</div>
                        <div class="corrPH">Remaining</div>
                ...
                <div class="addPartBorder">
                    <div class="addPageHeading">
                        <div class="col-md-4 col-sm-4 col-xs-4">Part Information</div>
                        <div class="col-md-4 col-sm-4 col-xs-4">Times Since (at Installed)</div>
                        <div class="col-md-4 col-sm-4 col-xs-4">Additional Information</div>
                    </div>
...
<style>
    ...
    .aircraft_component_selected, .aircraft_component_file_selected{
        max-height:75px;
        overflow-y: scroll;
    }
</style>
...
$(document).ready(function() {
    ...
    $(document).on('click', '#currentTimeId', function() {
        ...
        $.ajax({
            ...
            data: {plane_id: air_id, comp_id: comp_id},
            async: true,
            success: function(response) {
                var obj = JSON.parse(response);
                if(obj.status == 'success') {
...
$(document).on('change', '.aircraft_dropdown', function(e){
    ...
    if(planeId != ''){
        ...
        $.ajax({
            type: "POST",
            url: getComponents,
            data: {planeId:planeId, 'source':'airframe_comp_add'},
            async : true,
            success: function(response) {
                var obj = JSON.parse(response);
...
$(document).on('click', '.selectaircraftcomponent', function(e){
    ...
    $.ajax({
        ...
        data: {'aircraft':aircraftarr, 'component':componentarr},
        async : true,
        success: function(response) {
