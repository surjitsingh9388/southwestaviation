                ...
                <div id="aircraftTabs" style="padding: 15px 0 15px 0;">
                    <div class="container">
                        <ul class="nav nav-tabs">
                            ...
                            <li><a data-toggle="tab" href="#itemAttachment">Attachments <span class="count_circle airframe_part_attachment_count"><?php echo $attachmentcounts; ?></span></a></li>
                        </ul>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                                    <span class="form-control <?php echo $style; ?>" id="remHrs">
                                                        <?php 
                                                        echo (!empty($remHours) ? round($remHours,1) : ''); ?>
                                                    </span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="actionbar-lft">
                                        ...
                                        ?>
                                            ...
                                            <div class="dropdown-content dropdown-menu actionLinks" style="pointer-events: none;">
                                                <a href="javascript:void(0);" data-parentid="<?php echo $airCompParts['id']; ?>" class="resetPartCls">Remove</a>
                                            </div>
                                            <?php
                                            }
                                            ?>
