    ...
    <div class="calenderWrap">
   		<div class="selectWrap">
   			<div class="lft-Wrapper">
   				<?php 
   				echo $this->Form->control('pilot_id', array('options'=>$allPilots, 'class'=>'form-control selectpicker selPilotCls selDropDCls', 'div'=>false, 'label' => false, 'value'=>$pilotId)); 
   				
                echo $this->Form->control('current_month', array('options'=>$months, 'class'=>'form-control selectpicker selMonthCls selDropDCls', 'div'=>false, 'label' => false, 'value'=>$currentMon)); 
		        ...
		        echo $this->Form->control('current_year', array('options'=>$years, 'class'=>'form-control selectpicker selYearCls selDropDCls', 'div'=>false, 'label' => false, 'value'=>$currentYr));
                ?>
   			</div>
