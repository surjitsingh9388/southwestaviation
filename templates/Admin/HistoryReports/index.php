    ...
    <div class="outerWrapper">
        ...
        <div class="page-content mt-35">
            <div class="action-bar dflex" style="display:block;">
                ...
                ?>
                <div class="inputWrap btn-group col-md-12">
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="col-sm-3 col-xs-12 control-label" for="reference" style="color: white;font-size: 17px;">Section</label>
                            </span>
                            <div class="col-sm-9 col-xs-12 form-label-input-wrapper dropdown bootstrap-select bs3">
                                <?php 
                                $historyReports = unserialize(HISTORYREPORTS);
                                echo $this->Form->control('filterBySection', array('options' => $historyReports, 'empty' => 'Select Section', 'class' => 'form-control col-md-8 col-xs-12 selectpicker', 'data-show-subtext' => true, 'data-live-search' => true, 'label' => false, 'id' => 'FilterBySection', 'value'=>'inventory_item_histories'));  ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-7">
                        <div class="col-md-12">
                            <div class="col-md-3" style="padding:0px;"><label class="control-label" style="color: white;font-size: 17px; width:160px;">Date Range</label></div>
                            <div class="col-md-9" style="padding:0px;">
                                <div class="col-md-6 form-group"> 
                                    <div class="col-sm-12 col-xs-12 form-label-input-wrapper">
                                        <div class="input-group date datePicker" style="width:170px;">
                                            <?php 
                                            echo $this->Form->Text('date_from', array('class' => 'form-control', 'id' => 'date_from', 'placeholder' => 'Date From', 'label' => false, 'id'=>'histiroy_date_from', 'style'=>'width:170px;')); ?>
                                ...
                                <div class="col-md-6 form-group">
                                    <div class="col-sm-12 col-xs-12 form-label-input-wrapper">
                                        <div class="input-group date datePicker" style="width:170px;">
                                            <?php 
                                            echo $this->Form->Text('date_to', array('class' => 'form-control', 'id' => 'date_to', 'placeholder' => 'Date To', 'label' => false, 'id'=>'histiroy_date_to', 'style'=>'width:170px;')); ?>
                                            <span class="input-group-addon">
                                                <span class="glyphicon glyphicon-calendar"></span>
                                            </span>
                                        </div>
                    ...
                    <div class="col-md-2">
                        <button type="button" class="btn btn-primary applyfilterbtn ml-5">Submit</button>
                        <button type="button" class="btn ml-5 clearapplyfilter">Clear</button>
                    </div>
                </div>
