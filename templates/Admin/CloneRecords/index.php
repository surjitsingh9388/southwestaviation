                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="">
                                ...
                                <div class="well aircraftInfoCls" style="display: none;">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label text-space-left col-md-4 col-sm-12 col-xs-12 text-right-label" for="plane_serial_number">Serial Nnumber
                                        </label>
                                    ...
                                    <div class="form-group"> 
                                        <label class="control-label text-space-left col-md-4 col-sm-12 col-xs-12 " for="airworthiness_date">Airworthiness Date
                                        </label>
                                        <div class="col-md-8 col-sm-12 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label text-space-left col-md-4 col-sm-12 col-xs-12" for="plane_type">Make & Model
                                        </label>
                                        <div class="col-md-8 col-sm-12 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label text-space-left col-md-4 col-sm-12 col-xs-12" for="federal_aviation_regulation">Schedule Revision Level
                                        </label>
                                        <div class="col-md-8 col-sm-12 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label text-space-left col-md-4 col-sm-12 col-xs-12" for="hours">Hours 
                                        </label>
                                        <div class="col-md-8 col-sm-12 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label text-space-left col-md-4 col-sm-12 col-xs-12" for="cycles">Cycles 
                                        </label>
                                        <div class="col-md-8 col-sm-12  col-xs-12">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label text-space-left col-md-4 col-sm-12 col-xs-12" for="plane_name">Name
                                        </label>
                                        <div class="col-md-8 col-sm-12 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label text-space-left col-md-4 col-sm-12 col-xs-12" for="address">Address
                                        </label>
                                        <div class="col-md-8 col-sm-12 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label text-space-left col-md-4 col-sm-12 col-xs-12" for="manufacturered_by">Manufacturered By
                                        </label>
                                        <div class="col-md-8 col-sm-12 col-xs-12">
                                    ...
                                    <div class="form-group"> 
                                        <label class="control-label text-space-left col-md-4 col-sm-12 col-xs-12" for="manufacturered_on">Manufacturered On 
                                        </label>
                                        <div class="col-md-8 col-sm-12 col-xs-12">
                                            <div class="input-group date datePicker">
