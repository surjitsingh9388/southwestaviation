...
<div class="content sliding">
    <div class="outerWrapper">
        <div class="btnWrapper">
            <h2 class="heading">Add Requirement Source</h2>
            <?php
        ...
        <div class="page-content mt-35">
            ...
            <?php echo $this->Form->create($requirementSourceRes, array('class' => 'form-horizontal form-label-left', 'id' => 'frmRequirementSource')); ?>
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="title">Requirement Source Title <span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <?php echo $this->Form->control('title', array('class' => 'form-control col-md-7 col-xs-12', 'placeholder' => 'Requirement Source Title', 'label' => false, 'required' => 'required')); ?>
                            </div>
                        </div>
                        <div class="form-group">
...
$(document).ready(function() {
    $('#frmRequirementSource select.selectpicker').on('change', function(e) {
        $('#frmRequirementSource').validate().element($(this));
    });
    
    $( "#frmRequirementSource" ).validate( {
        ...
        messages: {
            'title': {
                required: 'Please enter Requirement Source.'
            }
        }
    });

    $('#reset').click(function() {
       var validator = $("#frmRequirementSource").validate();
       validator.resetForm();
    });
});    
</script>
