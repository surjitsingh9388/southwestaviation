                            ...
                            <div id='tab1'>
                                <form method="post" class="form-horizontal frmFlightLegs tabValidate form-label-left" data-tabnum="1">
                                    ...
                                    <div class="flightFields">
                                        ...
                                        <!-- Flight Information -->
                                        <div class="row" style="padding-top: 20px;margin-top: 15px;">
                                            <h4 class="col-md-3 col-xs-12">Flight Information</h4>
                                        </div>
                        ...
                        <div class="row allBtnCls">
                            <div class="col-md-10 col-sm-10 col-xs-12">
                                ...
                                if((!empty($actionItems) && $actionItems['action']['action_add'] == 1) || $sessionUser['id'] == 1) {
                                    ...
                                    <button type="submit" class="btn btn-success saveLaterCls" data-flstatus="fldetail">
                                        <i class="fa fa-save"></i> Save Data for Later
                                    </button>

                                    <button type="button" class="btn btn-success closeLegCls">
                                        <i class="fa fa-check"></i> Close Leg
                                    </button>

                                    <button type="button" class="btn btn-success closeTripCls">
                                        <i class="fa fa-plane"></i> Close Trip
                                    </button>
                                    ';
...
$(document).ready(function() {
	...
	var landing_hobbs = $("input[name=landing_hobbs]").val();
            ...
            success: function(response) {
                ...
                if(obj.status == 'success') {
                    setTimeout(function() {
                        ...
                        $('#tab'+num_tabs+' input[name=takeoff_hobbs]').val(landing_hobbs);
                    }, 500);
                }
            }                   
        });
