                            ...
                            foreach ($fls as $key => $value) {
                                ...
                                <div id="tab<?php echo $i; ?>">
                                    <form method="post" class="form-horizontal frmFlightLegs form-label-left">
                                        ...
                                        <input type="hidden" name="fld_id" value="<?php echo (!empty($value['flightlog_detail']['id']) ? $value['flightlog_detail']['id'] : ''); ?>">
                                        <input type="hidden" name="plane_id" value="<?php echo (!empty($value['plane_id']) ? $value['plane_id'] : ''); ?>" >
                                        ...
                                        <div class="gettab row" style="padding-top: 10px;">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <button type="button" class="btn btn-sm btn-success addCrewBtn" style="float:right;">
                                                            <i class="fa fa-plus"></i> Add Crew Member
                                                        </button>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row allBtnCls">
                                            <div class="col-md-10 col-sm-10 col-xs-12">
                                                ...
                                                if((!empty($actionItems) && $actionItems['action']['action_add'] == 1) || $sessionUser['id'] == 1) {
                                                    echo '<button type="button" class="btn btn-default deleteLeg">
                                                        <i class="fa fa-times"></i> Delete this Leg
                                                    </button>

                                                    <button type="button" class="btn btn-success add-before">
                                                        <i class="fa fa-plus"></i> Leg Before
                                                    </button>

                                                    <button type="button" class="btn btn-success add-after">
                                                        <i class="fa fa-plus"></i> Leg After
                                                    </button>

                                                    <button type="submit" class="btn btn-success saveLaterCls" data-flstatus="savelater">
                                                        <i class="fa fa-save"></i> Save for later
                                                    </button>

                                                    <button type="submit" class="btn btn-success saveLaterCls" data-flstatus="fllog">
                                                        <i class="fa fa-plane"></i> Schedule this Trip
                                                    </button>
                                                    ';
                                                }
                                                ?>
