        ...
        <div class="page-content mt-35">
            <div class="panel panel-default"> 
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="tableScroll" style="padding:10px;">
...
$(document).ready(function() {
    ...
    function getFlightLogList(planeId, startDt, endDt) {
        $.ajax({
            ...
            data: {planeId:planeId, startDt:startDt, endDt:endDt, type:''},
            async: true,
            beforeSend: function () {
                $('.loader').show();
            },
    ...
    $('#downloadFLPdf').on('click', function(e) {
        ...
        $.ajax({
            ...
            data: {planeId: planeId, startDt: startDt, endDt: endDt, type:'reportpdf'},
            beforeSend: function () {
                $('.loader').show();
            },
            success:function(response) {
