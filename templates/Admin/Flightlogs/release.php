                            ...
                            foreach ($fls as $key => $value) {
                                ...
                                <div id="tab<?php echo $i; ?>">
                                    <form method="post" class="form-horizontal frmFlightLegs form-label-left">
                                        ...
                                        <input type="hidden" name="form_type" class="formTypeCls" value="flrelease">
                                                        ...
                                                        <tbody class="crewMemberList">
                                                            ...
                                                            if(!empty($value['crews'])) {
                                                                ...
                                                                echo '<tr class="crewRow">
                                                                        <td colspan="7" style="text-align: center;">No crew members have been added for this leg.<input type="hidden" name="crew_member"></td>
                                                                    </tr>';
                                                            }
                                                            ?>
                                                        </tbody>
                                        ...
                                        <div class="row allBtnCls">
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                if((!empty($actionItems) && $actionItems['action']['action_add'] == 1) || $sessionUser['id'] == 1) {
                                                    ...
                                                    echo $this->Form->button('Release this Flight', ['type'=>'button', 'class'=>'btn btn-success saveLaterCls', 'data-flstatus'=>'flrelease']);
                                                }
                                                ?>
                                            </div>
                                        </div>
...
$(document).ready(function() {
    ...
    $(".frmFlightLegs").validate({
        ...
        errorPlacement: function(error,element) {
            alert('Please add at least one crew member to each leg before continuing.');
        }
    });
});
