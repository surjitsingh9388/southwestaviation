                    ...
                    <div class="">
                        <div class="col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <p class="form-control-static reference-white-space"><?php echo $InventoryRepairOrders->reference; ?> </p>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <p class="form-control-static"><?php echo $InventoryRepairOrders->contact; ?> </p>
                                </div>
                            </div>
