...
<div class="content sliding">
    <div class="outerWrapper">
        ...
        <div class="btnWrapper flex-column-mob">
            <h2 class="heading"><?php echo $this->Html->link('Repair Orders', ['action' => 'index']).' / Create'; ?></h2>
        ...
        <div class="page-content mt-35">
            <div class="formBGCls">
                <?php echo $this->element('Inventory/create_repair_order'); ?>
            </div>
        </div>
...
var deleteInventoriesAttURL = "<?php echo $this->Url->build(['controller'=>'InventoryRepairOrders', 'action'=>'deleteInventoryAttachment']); ?>";
