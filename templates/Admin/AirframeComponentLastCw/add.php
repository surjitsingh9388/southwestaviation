 ...
 * @var \Cake\Datasource\EntityInterface $AirframeComponentLastCw
 */
...
<div class="">
    <div class="page-title">
        <div class="title_left">
            <h3>Airframe Component Last C/W</h3>
        </div>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Add Airframe Component Last C/W</h2>
                    <?php
                ...
                <div class="x_content">
                    ...
                    <?php echo $this->Form->create($airCompLastCW, array('class' => 'form-horizontal form-label-left', 'id' => 'frmAirCompCat')); ?>
...
$(document).ready(function() {
    ...
    $('#reset').click(function() {
       var validator = $("#frmAirCompCat").validate();
       validator.resetForm();
    });
