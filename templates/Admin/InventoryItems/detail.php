                                        ...
                                        <table id="datatableQuantities" class="table dataTable table2excel" width="100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="valign-t" scope="col"><?php echo __('Received'); ?></th>
                                                    <th class="valign-t" scope="col"><?php echo __('W/O'); ?></th>
                                                    <th class="valign-t" scope="col"><?php echo __('Last Transaction'); ?></th>
                                        ...
                                        <table id="inventoryThresholdTable" class="table mb-0 invitemThresholdTable">
                                            ...
                                            <tbody id="inventoryThresholdList">
                                                ...
                                                <tr class="mainTR activeTble <?php echo $evenOdd; ?>">
                                                    ...
                                                    <td class="collapse-tr"><span class="thresholdloc hide-block"><?php echo $val['location_id'];?></span><?php echo $val['location_name'];?></td>
...
var inv_item_id = "<?php echo $invenotryitems->id; ?>";
...
exportLineItemsExcelURL += 'inv_item_id='+inv_item_id+'&';
exportListingDataExcelURL += 'inv_item_id='+inv_item_id+'&';
...
$(document).ready(function () {
    ...
    var dataTable = $('#datatableQuantities').DataTable({
        ...
        "ajax":{
            ...
            type: "post",
            data:{'inventory_item_id':inventory_item_id, 'defualt_status':'1'},
            error: function(){
