                ...
                <div id="aircraftTabs" class="tab-pad">
                    <div class="container">
                        <ul class="nav nav-tabs">
                            <li class="active"><a data-toggle="tab" href="#itemGeneral">Attachments <span class="count_circle inventory_attachment_count"><?php echo count($attachments); ?></span></a></li>
                        </ul>
...
var deleteInventoriesAttURL = "<?php echo $this->Url->build(['controller'=>'InventoryItems', 'action'=>'deleteAttachment']); ?>";
