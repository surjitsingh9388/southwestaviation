...
<div class="content sliding">
    <div class="outerWrapper">
        ...
        <div class="btnWrapper">
            <h2 class="heading"><?php echo $this->Html->link('Inventory Locations', ['action' => 'index']).' / Create'; ?></h2>
            <div class="btnWrap">
             <?php
                ...
                <div id="aircraftTabs" class="tab-pad">
                    <div class="container">
                        <ul class="nav nav-tabs">
                            <li class="active"><a data-toggle="tab" href="#itemAttachment">Attachments <span class="count_circle inventory_attachment_count">0</span></a></li>
                        </ul>
