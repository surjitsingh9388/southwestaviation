                ...
                <div class="row">
                    <div class="col-md-6 col-xs-12">
                        <div class="form-group"> 
                            ...
                            <?php echo '<p class="form-control-static">'.$invenotrylocations->location_name.'</p>'; ?>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 col-xs-12">
                        <div class="form-group"> 
                            ...
                            echo '<p class="form-control-static">'.$locationStatus[$invenotrylocations->location_status].'</p>'; ?>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-xs-12">
                        <div class="form-group"> 
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">
                            <a class="parent_location_name" href="<?php echo $this->Url->build(['action'=>'detail', $locationdata['id']]); ?>"><?php echo '<p class="form-control-static">'.$locationdata['location_name'].'</p>'; ?></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-xs-12">
                        <div class="form-group"> 
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">
                            <?php echo '<p class="form-control-static">'.$invenotrylocations->description.'</p>'; ?>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group"> 
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                <p class="form-control-static">
                                    ...
                                    ?>
                                    <img src="<?php echo BARCODEAPIURL; ?>chs=100x100&chl=<?php echo $bar_code; ?>" />
                                </p>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="mt5">
                                    ...
                                    <div class="col-sm-12 table-responsive">
                                        <table id="quantitiesTable" class="table mb-0">
                                            <thead>
                                                <tr>
                                                    <th class="check text-left"><input type="checkbox" name="air_check" id="ckbCheckAll"></th>
    ...
    <div class="modal-dialog" style="width: 40%; height:auto;">
        <div class="modal-content">
            ...
            <div class="modal-body" style="max-height: 500px;">
                <?php echo $this->Form->create(null, ['url' =>'', 'id' => 'formprintQuantitiesBarCode', 'autocomplete'=>'off']); ?>
