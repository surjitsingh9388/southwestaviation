...
<div class="content sliding">
    <div class="outerWrapper">
        ...
        <div class="page-content mt-35">
            ...
            <?php echo $this->Form->create($mocsRes, array('class' => 'form-horizontal form-label-left', 'id' => 'frmMocs')); ?>
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="title">SOC Title <span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <?php echo $this->Form->control('title', array('class' => 'form-control col-md-7 col-xs-12', 'placeholder' => 'SOC Title', 'label' => false, 'required' => 'required')); ?>
                            </div>
                        </div>
                        <div class="form-group">
...
$(document).ready(function() {
    $('#frmMocs select.selectpicker').on('change', function(e) {
        $('#frmMocs').validate().element($(this));
    });
    ...
    $( "#frmMocs" ).validate( {
        ...
        messages: {
            'title': {
                required: 'Please enter SOC.'
            }
        }
    });

    $('#reset').click(function() {
       var validator = $("#frmMocs").validate();
       validator.resetForm();
    });
});    
</script>
