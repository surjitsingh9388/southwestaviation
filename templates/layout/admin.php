...
<html lang="en">
    ...
    <body class="nav-md">
        ...
        <script>
            ...
            var approveDenyPTORequestsURL = "<?php echo $this->Url->build(['controller'=>'PtoRequests', 'action'=>'approveDenyPTORequests']); ?>";
            var headerSearchURL = "<?php echo $this->Url->build(['controller'=>'Searches', 'action'=>'search']); ?>";
