...
class MembershipsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'currency_id' => ['type' => 'integer', 'length' => 10, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        'deleted' => ['type' => 'smallinteger', 'length' => 6, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'membership_type' => ['type' => 'unique', 'columns' => ['membership_type_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
